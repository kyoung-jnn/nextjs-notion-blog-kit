...
echo ""
echo "  1. Visit the template page:"
echo "     https://kyoung-jnn.notion.site/1f4d55b8837780519a27c4f1f7e4b1a9?v=1f4d55b8837781328546000cc33d2d96"
...
echo -e "     ${YELLOW}Tip:${NC} Press Cmd+L (Mac) or Ctrl+L (Windows) to select the URL"
...
echo -e "     ${BLUE}pnpm deploy:prod${NC}"
echo ""
echo -e "  3. Preview deployment:"
echo -e "     ${BLUE}pnpm deploy:preview${NC}"
echo ""
