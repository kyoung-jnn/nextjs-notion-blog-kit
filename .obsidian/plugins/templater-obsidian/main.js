...
var zi = (n) => Yn(n, '__esModule', { value: !0 });
var Ta = (n, e) => {
    zi(n);
    for (var t in e) Yn(n, t, { get: e[t], enumerable: !0 });
  },
  ka = (n, e, t) => {
    if ((e && typeof e == 'object') || typeof e == 'function')
      for (let r of wa(e))
        !Ea.call(n, r) &&
          r !== 'default' &&
          Yn(n, r, { get: () => e[r], enumerable: !(t = va(e, r)) || t.enumerable });
    return n;
  },
  X = (n) =>
    ka(
...
var Ji = (() => {
  ...
  return (t) => {
    for (
      var r = t.length,
        i = new Uint8Array((((r - (t[r - 1] == '=') - (t[r - 2] == '=')) * 3) / 4) | 0),
        o = 0,
        a = 0;
      o < r;
      ...
      var l = n[t.charCodeAt(o++)],
        ...
        d = n[t.charCodeAt(o++)],
        m = n[t.charCodeAt(o++)];
      (i[a++] = (l << 2) | (c >> 4)), (i[a++] = (c << 4) | (d >> 2)), (i[a++] = (d << 6) | m);
    }
    return i;
  };
})();
Ta(exports, { default: () => qi });
var Tr = X(require('obsidian'));
var L = X(require('obsidian'));
var Qi = X(require('obsidian'));
function oe(n) {
  let e = new Qi.Notice('', 8e3),
    t = createFragment((r) => {
      r.createEl('b', { text: 'Templater Error' }),
        r.createEl('span', { text: ':' }),
        r.createEl('br'),
        r.createEl('span', { text: n.message }),
        n instanceof P &&
          n.console_msg &&
          (r.createEl('br'),
          r.createEl('span', { text: 'Check console for more information' }),
          console.error(
            'Templater Error:',
            n.message,
            `
...
async function Se(n, e) {
  try {
    ...
    return t instanceof P ? oe(t) : oe(new P(e, t.message)), null;
  }
}
function Ce(n, e) {
  try {
    ...
    return oe(new P(e, t.message)), null;
  }
}
var re = (function () {
  function n() {}
  return (
    ...
    (n.explainIfInvalidPackageName = function (e) {
      ...
      if (!n._validPackageNameRegExp.test(e))
        return 'The package name '.concat(JSON.stringify(e), ' is not a valid package name');
    }),
    (n.explainIfInvalidImportPath = function (e, t) {
      if (e.length > 0) {
        if (e.indexOf('//') >= 0) return 'An import path must not contain "//"';
        if (e[e.length - 1] === '/') return 'An import path must not end with "/"';
        if (!t && e[0] === '/')
    ...
    (n.explainIfInvalidUnquotedIdentifier = function (e) {
      ...
      if (n._identifierBadCharRegExp.test(e)) return 'The identifier cannot non-word characters';
  ...
  return (
    (n.prototype.registerDocNodes = function (e, t) {
      ...
      for (var i = 0, o = t; i < o.length; i++) {
        ...
        if (l !== void 0)
          throw new Error(
            'The DocNode kind "'.concat(a.docNodeKind, '" was already registered') +
              ' by '.concat(l.packageName),
          );
        if (((l = this._docNodeDefinitionsByConstructor.get(a.constructor)), l !== void 0))
          throw new Error(
            'This DocNode constructor was already registered by '.concat(l.packageName) +
    ...
    (n.prototype.throwIfNotRegisteredKind = function (e) {
      if (!this._docNodeDefinitionsByKind.has(e))
        throw new Error(
          'The DocNode kind "'.concat(e, '" was not registered with this TSDocConfiguration'),
        );
    }),
  ...
  return (
    (n.register = function (e) {
      ...
      t.registerDocNodes('@microsoft/tsdoc', [
        { docNodeKind: g.Block, constructor: zt },
        { docNodeKind: g.BlockTag, constructor: Un },
        { docNodeKind: g.CodeSpan, constructor: Gn },
        { docNodeKind: g.Comment, constructor: Wn },
        { docNodeKind: g.DeclarationReference, constructor: Vn },
        { docNodeKind: g.ErrorText, constructor: Pt },
        { docNodeKind: g.EscapedText, constructor: zn },
        { docNodeKind: g.Excerpt, constructor: j },
        { docNodeKind: g.FencedCode, constructor: Jn },
        { docNodeKind: g.HtmlAttribute, constructor: Qn },
        { docNodeKind: g.HtmlEndTag, constructor: Xn },
        { docNodeKind: g.HtmlStartTag, constructor: Zn },
        { docNodeKind: g.InheritDocTag, constructor: gn },
        { docNodeKind: g.InlineTag, constructor: Jt },
        { docNodeKind: g.LinkTag, constructor: er },
        { docNodeKind: g.MemberIdentifier, constructor: hn },
        { docNodeKind: g.MemberReference, constructor: tr },
        { docNodeKind: g.MemberSelector, constructor: nr },
        { docNodeKind: g.MemberSymbol, constructor: rr },
        { docNodeKind: g.Paragraph, constructor: st },
        { docNodeKind: g.ParamBlock, constructor: An },
        { docNodeKind: g.ParamCollection, constructor: mn },
        { docNodeKind: g.PlainText, constructor: Ve },
        { docNodeKind: g.Section, constructor: xt },
        { docNodeKind: g.SoftBreak, constructor: ir },
      ]),
...
(function (n) {
  (n.ConfigFileNotFound = 'tsdoc-config-file-not-found'),
    ...
    (n.CommentOpeningDelimiterSyntax = 'tsdoc-comment-missing-opening-delimiter'),
    (n.CommentMissingClosingDelimiter = 'tsdoc-comment-missing-closing-delimiter'),
    ...
    (n.ParamTagWithInvalidOptionalName = 'tsdoc-param-tag-with-invalid-optional-name'),
    ...
    (n.ReferenceMalformedPackageName = 'tsdoc-reference-malformed-package-name'),
    ...
    (n.ReferenceSelectorMissingParens = 'tsdoc-reference-selector-missing-parens'),
...
var Br = (function () {
  function n() {
    (this._tagDefinitions = []),
      ...
      (this._validation = new Or()),
      (this._docNodeManager = new Nr()),
  ...
  return (
    ...
    (n.prototype.addTagDefinition = function (e) {
      ...
      if (t !== e) {
        if (t) throw new Error('A tag is already defined using the name '.concat(t.tagName));
        this._tagDefinitions.push(e), this._tagDefinitionsByName.set(e.tagNameWithUpperCase, e);
      }
    }),
    ...
    (n.prototype.isTagSupported = function (e) {
      return this._requireTagToBeDefined(e), this._supportedTagDefinitions.has(e);
    }),
    (n.prototype.setSupportForTag = function (e, t) {
      this._requireTagToBeDefined(e),
        t ? this._supportedTagDefinitions.add(e) : this._supportedTagDefinitions.delete(e),
    ...
    (n.prototype.setSupportedHtmlElements = function (e) {
      this._supportedHtmlElements.clear(), (this._validation.reportUnsupportedHtmlElements = !0);
  ...
  return (
    ...
    (n.prototype.addTag = function (e) {
      return this._nodesByName.has(e.tagNameWithUpperCase)
        ? !1
        : (this._nodesByName.set(e.tagNameWithUpperCase, e), this._nodes.push(e), !0);
    }),
    n
  );
})();
...
var Ca = (function () {
  ...
  ar = (function (n) {
    ...
    function e(t, r) {
      ...
      return (i._nodes = []), r !== void 0 && r.length > 0 && i.appendNodes(r), i;
    }
    return (
      ...
      (e.prototype.appendNode = function (t) {
        if (!this.configuration.docNodeManager.isAllowedChild(this.kind, t.kind))
          throw new Error(
            'The TSDocConfiguration does not allow a '.concat(this.kind, ' node to') +
  ...
  xt = (function (n) {
    ...
    return (
      ...
      (e.prototype.appendNodeInParagraph = function (t) {
        ...
        r || ((r = new st({ configuration: this.configuration })), this.appendNode(r)),
          r.appendNode(t);
      }),
...
var Na = (function () {
  ...
  zt = (function (n) {
    ...
    function e(t) {
      ...
      return (
        (r._blockTag = t.blockTag), (r._content = new xt({ configuration: r.configuration })), r
      );
    }
    return (
      Object.defineProperty(e.prototype, 'kind', {
  ...
  Gn = (function (n) {
    ...
    return (
      ...
      Object.defineProperty(e.prototype, 'code', {
        get: function () {
          return (
            this._code === void 0 && (this._code = this._codeExcerpt.content.toString()), this._code
          );
        },
        enumerable: !1,
        configurable: !0,
...
var eo = (function () {
  ...
  return (
    (n.transform = function (e) {
      for (var t = [], r = !1, i = [], o = [], a = !1, l = 0, c = e.nodes; l < c.length; l++) {
        var d = c[l];
        switch (d.kind) {
          case g.PlainText:
            var m = d,
              ...
              w = /^\s/.test(_),
              b = /\s$/.test(_),
              S = _.replace(/\s+/g, ' ').trim();
            w && a && (r = !0),
              S.length > 0 && (r && (i.push(' '), (r = !1)), i.push(S), o.push(d), (a = !0)),
              b && a && (r = !0);
            break;
          case g.SoftBreak:
            a && (r = !0), o.push(d);
          ...
          default:
            r && (i.push(' '), (r = !1)),
              i.length > 0 &&
                (t.push(new Ve({ configuration: e.configuration, text: i.join('') })),
                (i.length = 0),
                (o.length = 0)),
              t.push(d),
              (a = !0);
      ...
      i.length > 0 &&
        ...
        (i.length = 0),
        (o.length = 0));
      var k = new st({ configuration: e.configuration });
...
var qr = (function () {
  ...
  return (
    (n.trimSpacesInParagraph = function (e) {
      return eo.transform(e);
    }),
    n
  );
})();
var Lr = function (n, e, t) {
...
`),
  ...
  return (
        ...
        switch (e.kind) {
          case g.Block:
            ...
            this._ensureLineSkipped(),
              ...
              r.blockTag.tagNameWithUpperCase === G.returns.tagNameWithUpperCase &&
                (this._writeContent(' '), (this._hangingParagraph = !0)),
              this._renderNode(r.content);
            break;
          case g.BlockTag:
            var i = e;
            this._lineState === he.MiddleOfLine && this._writeContent(' '),
              this._writeContent(i.tagName);
            break;
          case g.CodeSpan:
            var o = e;
            this._writeContent('`'), this._writeContent(o.code), this._writeContent('`');
            break;
          case g.Comment:
            var a = e;
            this._renderNodes(
              ...
              a.modifierTagSet.nodes.length > 0 &&
                (this._ensureLineSkipped(), this._renderNodes(a.modifierTagSet.nodes));
            break;
          case g.DeclarationReference:
            var l = e;
            this._writeContent(l.packageName),
              this._writeContent(l.importPath),
              (l.packageName !== void 0 || l.importPath !== void 0) && this._writeContent('#'),
          ...
          case g.HtmlAttribute:
            var _ = e;
            this._writeContent(_.name),
              this._writeContent(_.spacingAfterName),
              this._writeContent('='),
              this._writeContent(_.spacingAfterEquals),
              this._writeContent(_.value),
              this._writeContent(_.spacingAfterValue);
            break;
          case g.HtmlEndTag:
            var w = e;
            this._writeContent('</'), this._writeContent(w.name), this._writeContent('>');
            break;
          case g.HtmlStartTag:
            var b = e;
            this._writeContent('<'),
              this._writeContent(b.name),
              this._writeContent(b.spacingAfterName);
            for (
              var S = b.spacingAfterName === void 0 || b.spacingAfterName.length === 0,
                k = 0,
                E = b.htmlAttributes;
              k < E.length;
              k++
              ...
              var O = E[k];
              S && this._writeContent(' '),
                this._renderNode(O),
                (S = O.spacingAfterValue === void 0 || O.spacingAfterValue.length === 0);
            }
            this._writeContent(b.selfClosingTag ? '/>' : '>');
            break;
          ...
          case g.InlineTag:
            ...
            this._renderInlineTag(K, function () {
              K.tagContent.length > 0 && (t._writeContent(' '), t._writeContent(K.tagContent));
            });
            break;
          case g.LinkTag:
            var D = e;
            this._renderInlineTag(D, function () {
              (D.urlDestination !== void 0 || D.codeDestination !== void 0) &&
                (D.urlDestination !== void 0
                  ? (t._writeContent(' '), t._writeContent(D.urlDestination))
                  : D.codeDestination !== void 0 &&
                    (t._writeContent(' '), t._renderNode(D.codeDestination))),
                D.linkText !== void 0 &&
                  (t._writeContent(' '),
                  t._writeContent('|'),
                  t._writeContent(' '),
                  t._writeContent(D.linkText));
            });
            break;
          case g.MemberIdentifier:
            var H = e;
            H.hasQuotes
              ? (this._writeContent('"'), this._writeContent(H.identifier), this._writeContent('"'))
              : this._writeContent(H.identifier);
            break;
          case g.MemberReference:
            var F = e;
            F.hasDot && this._writeContent('.'),
              F.selector && this._writeContent('('),
              F.memberSymbol
                ? this._renderNode(F.memberSymbol)
                : this._renderNode(F.memberIdentifier),
              F.selector &&
                (this._writeContent(':'), this._renderNode(F.selector), this._writeContent(')'));
            break;
          ...
          case g.MemberSymbol:
            var te = e;
            this._writeContent('['), this._renderNode(te.symbolReference), this._writeContent(']');
            break;
          case g.Section:
            var ne = e;
            ...
            break;
          case g.Paragraph:
            var Q = qr.trimSpacesInParagraph(e);
            Q.nodes.length > 0 &&
              (this._hangingParagraph ? (this._hangingParagraph = !1) : this._ensureLineSkipped(),
    ...
    (n.prototype._renderInlineTag = function (e, t) {
      this._writeContent('{'), this._writeContent(e.tagName), t(), this._writeContent('}');
    }),
    ...
    (n.prototype._ensureAtStartOfLine = function () {
      this._lineState === he.MiddleOfLine && this._writeNewline();
    }),
    (n.prototype._ensureLineSkipped = function () {
      this._ensureAtStartOfLine(), this._previousLineHadContent && this._writeNewline();
    }),
    (n.prototype._writeContent = function (e) {
      if (!(e === void 0 || e.length === 0)) {
        ...
        this._lineState === he.Closed &&
          ...
          (this._lineState = he.StartOfLine)),
          this._lineState === he.StartOfLine &&
            this._emitCommentFraming &&
            this._output.append(' '),
          this._output.append(e),
          (this._lineState = he.MiddleOfLine),
    ...
    (n.prototype._writeNewline = function () {
      this._lineState === he.Closed &&
        (this._emitCommentFraming && this._output.append('/**' + this.eol + ' *'),
        (this._lineState = he.StartOfLine)),
        (this._previousLineHadContent = this._lineState === he.MiddleOfLine),
        this._emitCommentFraming
    ...
    (n.prototype._writeEnd = function () {
      this._lineState === he.MiddleOfLine && this._emitCommentFraming && this._writeNewline(),
        this._lineState !== he.Closed &&
          (this._emitCommentFraming && this._output.append('/' + this.eol),
          (this._lineState = he.Closed));
    }),
    ...
    return (
      ...
      (e.prototype.add = function (t) {
        this._blocks.push(t),
          ...
          this._blocksByName.has(t.parameterName) || this._blocksByName.set(t.parameterName, t);
      }),
...
var Fa = (function () {
  ...
  Wn = (function (n) {
    ...
    function e(t) {
      var r = n.call(this, t) || this;
      return (
        (r.summarySection = new xt({ configuration: r.configuration })),
        (r.remarksBlock = void 0),
        (r.privateRemarks = void 0),
        (r.deprecatedBlock = void 0),
        (r.params = new mn({ configuration: r.configuration })),
        (r.typeParams = new mn({ configuration: r.configuration })),
        (r.returnsBlock = void 0),
        (r.modifierTagSet = new Fr()),
        (r._seeBlocks = []),
        (r._customBlocks = []),
        r
      );
  ...
  Pt = (function (n) {
    ...
    return (
      ...
      Object.defineProperty(e.prototype, 'text', {
        get: function () {
          return (
            this._text === void 0 && (this._text = this._textExcerpt.content.toString()), this._text
          );
        },
        enumerable: !1,
        configurable: !0,
      ...
      return (
        T.isParsedParameters(t)
          ? ((r._openingFenceExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.FencedCode_OpeningFence,
            ...
            t.languageExcerpt &&
              (r._languageExcerpt = new j({
                configuration: r.configuration,
                excerptKind: y.FencedCode_Language,
            ...
            (r._closingFenceExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.FencedCode_ClosingFence,
  ...
  Qn = (function (n) {
      ...
      return (
        T.isParsedParameters(t)
          ? ((r._nameExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.HtmlAttribute_Name,
            ...
            (r._equalsExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.HtmlAttribute_Equals,
            ...
            (r._valueExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.HtmlAttribute_Value,
    ...
    return (
      ...
      Object.defineProperty(e.prototype, 'name', {
        get: function () {
          return (
            this._name === void 0 && (this._name = this._nameExcerpt.content.toString()), this._name
          );
        },
        enumerable: !1,
        configurable: !0,
      ...
      Object.defineProperty(e.prototype, 'value', {
        get: function () {
          return (
            this._value === void 0 && (this._value = this._valueExcerpt.content.toString()),
            this._value
          );
        },
        enumerable: !1,
    ...
    function e(t) {
      ...
      return (
        T.isParsedParameters(t)
          ? ((r._openingDelimiterExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.HtmlEndTag_OpeningDelimiter,
              content: t.openingDelimiterExcerpt,
            })),
            (r._nameExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.HtmlEndTag_Name,
              content: t.nameExcerpt,
            })),
            t.spacingAfterNameExcerpt &&
              (r._spacingAfterNameExcerpt = new j({
            ...
            (r._closingDelimiterExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.HtmlEndTag_ClosingDelimiter,
              content: t.closingDelimiterExcerpt,
            })))
          : (r._name = t.name),
        r
  ...
  Zn = (function (n) {
      ...
      return (
        T.isParsedParameters(t)
          ? ((i._openingDelimiterExcerpt = new j({
              configuration: i.configuration,
              excerptKind: y.HtmlStartTag_OpeningDelimiter,
              content: t.openingDelimiterExcerpt,
            })),
            (i._nameExcerpt = new j({
              configuration: i.configuration,
              excerptKind: y.HtmlStartTag_Name,
              content: t.nameExcerpt,
            })),
            t.spacingAfterNameExcerpt &&
            ...
            (i._closingDelimiterExcerpt = new j({
              configuration: i.configuration,
              excerptKind: y.HtmlStartTag_ClosingDelimiter,
              content: t.closingDelimiterExcerpt,
            })))
          : ((i._name = t.name), (i._spacingAfterName = t.spacingAfterName)),
        (i._htmlAttributes = []),
        t.htmlAttributes && (r = i._htmlAttributes).push.apply(r, t.htmlAttributes),
    ...
    return (
      ...
      (e.prototype.onGetChildNodes = function () {
        return to(
          to(
            [this._openingDelimiterExcerpt, this._nameExcerpt, this._spacingAfterNameExcerpt],
  ...
  Qt = (function (n) {
    ...
    function e(t) {
      ...
      return (
        ...
        T.isParsedParameters(t) &&
          ((r._openingDelimiterExcerpt = new j({
            configuration: r.configuration,
            excerptKind: y.InlineTag_OpeningDelimiter,
            content: t.openingDelimiterExcerpt,
          })),
          (r._tagNameExcerpt = new j({
            configuration: r.configuration,
            excerptKind: y.InlineTag_TagName,
            content: t.tagNameExcerpt,
          })),
          ...
          (r._closingDelimiterExcerpt = new j({
            configuration: r.configuration,
            excerptKind: y.InlineTag_ClosingDelimiter,
            content: t.closingDelimiterExcerpt,
          }))),
        (r._tagName = t.tagName),
        (r._tagNameWithUpperCase = t.tagName.toUpperCase()),
    ...
    return (
      ...
      (e.prototype.onGetChildNodes = function () {
        return no(
          no(
            [this._openingDelimiterExcerpt, this._tagNameExcerpt, this._spacingAfterTagNameExcerpt],
        ...
        T.isParsedParameters(t)
          ? t.tagContentExcerpt &&
            (r._tagContentExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.InlineTag_TagContent,
      ...
      if (((r._codeDestination = t.codeDestination), T.isParsedParameters(t))) {
        ...
        t.urlDestinationExcerpt &&
          (r._urlDestinationExcerpt = new j({
            configuration: r.configuration,
            excerptKind: y.LinkTag_UrlDestination,
          ...
          t.linkTextExcerpt &&
            (r._linkTextExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.LinkTag_LinkText,
        ...
        T.isParsedParameters(t)
          ? (t.leftQuoteExcerpt &&
              (r._leftQuoteExcerpt = new j({
                configuration: r.configuration,
                excerptKind: y.MemberIdentifier_LeftQuote,
                content: t.leftQuoteExcerpt,
              })),
            (r._identifierExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.MemberIdentifier_Identifier,
              content: t.identifierExcerpt,
            })),
            t.rightQuoteExcerpt &&
              (r._rightQuoteExcerpt = new j({
                configuration: r.configuration,
                excerptKind: y.MemberIdentifier_RightQuote,
        ...
        T.isParsedParameters(t)
          ? ((r._hasDot = !!t.dotExcerpt),
            t.dotExcerpt &&
              (r._dotExcerpt = new j({
                configuration: r.configuration,
                excerptKind: y.MemberReference_Dot,
            ...
            t.leftParenthesisExcerpt &&
              (r._leftParenthesisExcerpt = new j({
                configuration: r.configuration,
                excerptKind: y.MemberReference_LeftParenthesis,
            ...
            t.colonExcerpt &&
              (r._colonExcerpt = new j({
                excerptKind: y.MemberReference_Colon,
                configuration: r.configuration,
            ...
            t.rightParenthesisExcerpt &&
              (r._rightParenthesisExcerpt = new j({
                configuration: r.configuration,
                excerptKind: y.MemberReference_RightParenthesis,
...
var Xa = (function () {
  ...
  Xt;
(function (n) {
  (n.Error = 'error'), (n.System = 'system'), (n.Index = 'index'), (n.Label = 'label');
})(Xt || (Xt = {}));
var nr = (function (n) {
  Xa(e, n);
  function e(t) {
      ...
      return (
        T.isParsedParameters(t) &&
          ((r._leftBracketExcerpt = new j({
            configuration: r.configuration,
            excerptKind: y.DocMemberSymbol_LeftBracket,
          ...
          (r._rightBracketExcerpt = new j({
            configuration: r.configuration,
            excerptKind: y.DocMemberSymbol_RightBracket,
      ...
      return (
        ...
        T.isParsedParameters(t) &&
          ...
          (r._parameterNameExcerpt = new j({
            configuration: r.configuration,
            excerptKind: y.ParamBlock_ParameterName,
          ...
          t.hyphenExcerpt &&
            (r._hyphenExcerpt = new j({
              configuration: r.configuration,
              excerptKind: y.ParamBlock_Hyphen,
    ...
    (n._scanTextContent = function (e, t, r) {
      for (var i = 0, o = e; i < o.length; i++) {
        ...
        switch (a.kind) {
          ...
          case g.PlainText:
            var _ = a;
            r += n._countNonSpaceCharacters(_.text);
            break;
        }
        if (r >= t || ((r += n._scanTextContent(a.getChildNodes(), t, r)), r >= t)) break;
      }
      return r;
    }),
...
var _n = (function () {
  ...
  return (
    (n._formatMessageText = function (e, t) {
      if ((e || (e = 'An unknown error occurred'), t.pos !== 0 || t.end !== 0)) {
    ...
    Object.defineProperty(n.prototype, 'text', {
      get: function () {
        return (
          this._text === void 0 &&
            (this._text = n._formatMessageText(this.unformattedText, this.textRange)),
          this._text
        );
      },
      enumerable: !1,
...
var Hr = (function () {
  ...
  return (
    ...
    (n.prototype.addMessageForTextRange = function (e, t, r) {
      this.addMessage(new _n({ messageId: e, messageText: t, textRange: r }));
    }),
...
var $r = (function () {
  function n(e, t) {
    (this.commentRange = ze.empty),
      (this.lines = []),
      (this.tokens = []),
      (this.configuration = e),
      (this.sourceRange = t),
      (this.docComment = new Wn({ configuration: this.configuration })),
      (this.log = new Hr());
  }
  return n;
})();
var yt = (function () {
  ...
  return (
    ...
    (n.prototype.getNewSequence = function (e, t) {
      return new n({ parserContext: this.parserContext, startIndex: e, endIndex: t });
    }),
    ...
    (n.prototype._validateBounds = function () {
      if (this.startIndex < 0) throw new Error('TokenSequence.startIndex cannot be negative');
      if (this.endIndex < 0) throw new Error('TokenSequence.endIndex cannot be negative');
  ...
  return (
    (n.extract = function (e) {
      for (
        ...
        if (c >= t.end)
          switch (d) {
            ...
            case pe.BeginComment2:
              return (
                e.log.addMessageForTextRange(v.CommentNotFound, 'Expecting a "/**" comment', t), !1
              );
            default:
              return (
        ...
        switch (d) {
          case pe.BeginComment1:
            if (_ === '/' && b === '*') (i = w), ++c, (d = pe.BeginComment2);
            else if (!n._whitespaceCharacterRegExp.test(_))
              return (
                e.log.addMessageForTextRange(
            ...
            break;
          case pe.BeginComment2:
            if (_ === '*') b === ' ' && ++c, (a = c), (l = c), (d = pe.CollectingFirstLine);
            else
              return (
                e.log.addMessageForTextRange(
                  v.CommentOpeningDelimiterSyntax,
          ...
          case pe.CollectingLine:
            ...
            `
`
              ? ((d !== pe.CollectingFirstLine || l > a) && m.push(t.getNewRange(a, l)),
                (a = c),
                (l = c),
                (d = pe.AdvancingLine))
              : _ === '*' && b === '/'
                ? (l > a && m.push(t.getNewRange(a, l)),
                  ...
                  (o = c),
                  (d = pe.Done))
                : n._whitespaceCharacterRegExp.test(_) || (l = c);
            break;
          case pe.AdvancingLine:
            _ === '*'
              ? b === '/'
                ? ((a = 0), (l = 0), ++c, (o = c), (d = pe.Done))
                : (b === ' ' && ++c, (a = c), (l = c), (d = pe.CollectingLine))
              : _ ===
                  `
`
                ? (m.push(t.getNewRange(w, w)), (a = c))
                : n._whitespaceCharacterRegExp.test(_) || ((l = c), (d = pe.CollectingLine));
            break;
        }
      }
...
var xn = (function () {
  ...
  return (
    (n.readTokens = function (e) {
      ...
      return (
        r
          ? t.push(new Nt(u.EndOfInput, r.getNewRange(r.end, r.end), r))
          : t.push(new Nt(u.EndOfInput, ze.empty, ze.empty)),
        t
      );
    }),
      ...
      for (var r = t.buffer, i = t.end, o = t.pos, a = void 0, l = o; o < i; ) {
        ...
        d === void 0 && (d = u.Other),
          (a !== void 0 && d === a && n._isMultiCharacterToken(a)) ||
            (a !== void 0 && e.push(new Nt(a, t.getNewRange(l, o), t)), (l = o), (a = d)),
          ++o;
      }
      a !== void 0 && e.push(new Nt(a, t.getNewRange(l, o), t)),
        e.push(new Nt(u.Newline, t.getNewRange(t.end, t.end), t));
    }),
    ...
    (n._ensureInitialized = function () {
      if (!n._charCodeMap) {
        ...
        for (var e = n._commonMarkPunctuationCharacters, t = 0; t < e.length; ++t) {
        ...
        for (
          ...
          var l = a[o];
          (n._charCodeMap[l.charCodeAt(0)] = i[l]), (n._punctuationTokens[i[l]] = !0);
        }
    ...
    (n._wordCharacters = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_'),
    n
  );
})();
var Kr = (function () {
  function n(e, t) {
    if (((this._parserContext = e), (this.tokens = e.tokens), t)) {
      ...
      (this._readerStartIndex = t.startIndex), (this._readerEndIndex = t.endIndex);
    } else (this._readerStartIndex = 0), (this._readerEndIndex = this.tokens.length);
  ...
  return (
    ...
    (n.prototype.tryExtractAccumulatedSequence = function () {
      if (!this.isAccumulatedSequenceEmpty()) return this.extractAccumulatedSequence();
    }),
...
` + JSON.stringify(t),
    ...
    (n.prototype.readToken = function () {
      ...
      if (e.kind === u.EndOfInput) throw new Error('The EndOfInput token cannot be read');
      return this._currentIndex++, e;
    }),
    (n.prototype.peekPreviousTokenKind = function () {
      return this._currentIndex === 0 ? u.EndOfInput : this.tokens[this._currentIndex - 1].kind;
    }),
...
var io = (function () {
  ...
  return (
    (n.prototype.parse = function () {
      for (var e = new Kr(this._parserContext), t = !1; !t; )
        switch (e.peekTokenKind()) {
          ...
          case u.Newline:
            ...
            break;
          case u.Backslash:
            this._pushAccumulatedPlainText(e), this._pushNode(this._parseBackslashEscape(e));
            break;
          case u.AtSign:
          ...
          case u.Backtick:
            this._pushAccumulatedPlainText(e),
              e.peekTokenAfterKind() === u.Backtick && e.peekTokenAfterAfterKind() === u.Backtick
    ...
    (n.prototype._performValidationChecks = function () {
      ...
      e.deprecatedBlock &&
        (lr.hasAnyTextContent(e.deprecatedBlock) ||
        ...
        e.inheritDocTag &&
          ...
          lr.hasAnyTextContent(e.summarySection) &&
    ...
    (n.prototype._validateTagDefinition = function (e, t, r, i, o) {
      if (e) {
        ...
        a !== r
          ...
          : this._parserContext.configuration.validation.reportUnsupportedTags &&
        ...
        this._parserContext.configuration.validation.ignoreUndefinedTags ||
          this._parserContext.log.addMessageForTokenSequence(
            v.UndefinedTag,
            'The TSDoc tag "'.concat(t, '" is not defined in this configuration'),
            i,
            o,
          );
    }),
    ...
    (n.prototype._parseAndPushBlock = function (e) {
      ...
      if ((this._validateTagDefinition(l, a.tagName, !1, a.getTokenSequence(), a), l))
        switch (l.syntaxKind) {
          case R.BlockTag:
            if (a.tagNameWithUpperCase === G.param.tagNameWithUpperCase) {
              var c = this._parseParamBlock(e, a, G.param.tagName);
              this._parserContext.docComment.params.add(c), (this._currentSection = c.content);
              return;
            } else if (a.tagNameWithUpperCase === G.typeParam.tagNameWithUpperCase) {
              var c = this._parseParamBlock(e, a, G.typeParam.tagName);
              this._parserContext.docComment.typeParams.add(c), (this._currentSection = c.content);
              return;
            } else {
              var d = new zt({ configuration: this._configuration, blockTag: a });
              this._addBlockToDocComment(d), (this._currentSection = d.content);
            }
            return;
          case R.ModifierTag:
            i.addTag(a);
    ...
    (n.prototype._tryParseUnsupportedJSDocType = function (e, t, r) {
      if (
        ...
        !(e.peekTokenKind() !== u.LeftCurlyBracket || e.peekTokenAfterKind() === u.AtSign))
      ) {
        var i = e.createMarker();
        e.readToken();
        var o = this._tryParseJSDocTypeOrValueRest(e, u.LeftCurlyBracket, u.RightCurlyBracket, i);
        if (o) {
          this._parserContext.log.addMessageForTokenSequence(
    ...
    (n.prototype._tryParseJSDocOptionalNameRest = function (e) {
      if ((e.assertAccumulatedSequenceIsEmpty(), e.peekTokenKind() !== u.EndOfInput)) {
        var t = e.createMarker();
        return this._tryParseJSDocTypeOrValueRest(e, u.LeftSquareBracket, u.RightSquareBracket, t);
      }
    }),
    (n.prototype._parseParamBlock = function (e, t, r) {
      ...
      if (m !== void 0) {
        e.backtrackToMarker(i);
        var _ = new An({ configuration: this._configuration, blockTag: t, parameterName: '' }),
          w =
            c.length > 0
              ? 'The ' + r + ' block should be followed by a valid parameter name: ' + m
      ...
      var b = e.extractAccumulatedSequence(),
        S;
      if (l) {
        S = this._tryParseJSDocOptionalNameRest(e);
        var k = l;
        S && (k = t.getTokenSequence().getNewSequence(l.startIndex, S.endIndex)),
          this._parserContext.log.addMessageForTokenSequence(
      ...
      var E = this._tryReadSpacingAndNewlines(e),
        O = this._tryParseUnsupportedJSDocType(e, t, r),
        $,
        K,
        D;
      return (
        e.peekTokenKind() === u.Hyphen
          ? (e.readToken(),
            ...
            (D = this._tryParseUnsupportedJSDocType(e, t, r)))
          : this._parserContext.log.addMessageForTokenSequence(
              v.ParamTagMissingHyphen,
              'The ' + r + ' block should be followed by a parameter name and then a hyphen',
              t.getTokenSequence(),
              t,
            ),
        new An({
          ...
          parameterNameExcerpt: b,
          parameterName: c,
          unsupportedJsdocOptionalNameRestExcerpt: S,
          spacingAfterParameterNameExcerpt: E,
          unsupportedJsdocTypeAfterParameterNameExcerpt: O,
          hyphenExcerpt: $,
          spacingAfterHyphenExcerpt: K,
          unsupportedJsdocTypeAfterHyphenExcerpt: D,
        })
      );
    }),
    ...
    (n.prototype._parseBackslashEscape = function (e) {
      ...
      return new zn({
        parsed: !0,
        configuration: this._configuration,
        escapeStyle: cr.CommonMarkBackslash,
      ...
      switch (e.peekTokenKind()) {
        ...
        default:
          ...
          return this._backtrackAndCreateError(
            ...
            'The token "'.concat(r, '" looks like a TSDoc tag but contains an invalid character') +
              ' '.concat(
                JSON.stringify(o),
    ...
    (n.prototype._parseInlineTag = function (e) {
      ...
      for (var o = e.readToken().toString(); e.peekTokenKind() === u.AsciiWord; )
      ...
      for (var m = !1; !m; )
        switch (e.peekTokenKind()) {
          ...
          case u.Backslash:
            if ((e.readToken(), !xn.isPunctuation(e.peekTokenKind()))) {
      ...
      var _ = e.tryExtractAccumulatedSequence();
      e.readToken();
      var w = e.extractAccumulatedSequence(),
        b = {
          parsed: !0,
          configuration: this._configuration,
          ...
          tagContentExcerpt: _,
          closingDelimiterExcerpt: w,
        },
        S = o.toUpperCase(),
        k = new Kr(this._parserContext, _ || yt.createEmpty(this._parserContext)),
        E;
      switch (S) {
        case G.inheritDoc.tagNameWithUpperCase:
          E = this._parseInheritDocTag(b, k);
          break;
      ...
      var O = this._parserContext.configuration.tryGetTagDefinitionWithUpperCase(S);
    ...
    (n.prototype._parseInheritDocTag = function (e, t) {
      ...
      if (t.peekTokenKind() !== u.EndOfInput) {
        if (
          ((i.declarationReference = this._parseDeclarationReference(t, e.tagNameExcerpt, r)),
    ...
    (n.prototype._parseLinkTag = function (e, t) {
      ...
      for (
        var o = t.peekTokenKind() === u.Slash && t.peekTokenAfterKind() === u.Slash,
          a = t.createMarker(),
          l = o;
        !l;
        ...
        switch (t.peekTokenKind()) {
          ...
          case u.Colon:
            t.readToken(),
              (o = t.peekTokenKind() === u.Slash && t.peekTokenAfterKind() === u.Slash),
              (l = !0);
            break;
          default:
            l = !0;
      ...
      if ((t.backtrackToMarker(a), o)) {
        if (!this._parseLinkTagUrlDestination(t, i, e.tagNameExcerpt, r)) return r;
      } else if (!this._parseLinkTagCodeDestination(t, i, e.tagNameExcerpt, r)) return r;
          ...
          (c === void 0
            ...
            : c >= m.endIndex
              ...
              : ((i.linkTextExcerpt = m.getNewSequence(m.startIndex, c)),
                (i.spacingAfterLinkTextExcerpt = m.getNewSequence(c, m.endIndex))));
    ...
    (n.prototype._parseLinkTagUrlDestination = function (e, t, r, i) {
      ...
      if (o.length === 0) throw new Error('Missing URL in _parseLinkTagUrlDestination()');
      var l = e.extractAccumulatedSequence(),
        c = re.explainIfInvalidLinkUrl(o);
      return c
        ? (this._parserContext.log.addMessageForTokenSequence(v.LinkTagInvalidUrl, c, l, i), !1)
        : ((t.urlDestinationExcerpt = l),
          (t.spacingAfterDestinationExcerpt = this._tryReadSpacingAndNewlines(e)),
          !0);
    }),
    (n.prototype._parseLinkTagCodeDestination = function (e, t, r, i) {
      return (t.codeDestination = this._parseDeclarationReference(e, r, i)), !!t.codeDestination;
    }),
    (n.prototype._parseDeclarationReference = function (e, t, r) {
      ...
      if (o) {
        if (e.peekTokenKind() !== u.Period) {
          var b = e.peekTokenKind() === u.AtSign,
            S = !1;
          for (c = !1; !c; )
            switch (e.peekTokenKind()) {
              case u.EndOfInput:
        ...
        if (e.peekTokenKind() !== u.PoundSymbol) throw new Error('Expecting pound symbol');
        if (
          (e.readToken(),
          (_ = e.extractAccumulatedSequence()),
          (w = this._tryReadSpacingAndNewlines(e)),
          d === void 0 && m === void 0)
        ) {
          this._parserContext.log.addMessageForTokenSequence(
      ...
      for (c = !1; !c; )
        switch (e.peekTokenKind()) {
          ...
          case u.DoubleQuote:
            var O = E.length > 0,
              $ = this._parseMemberReference(e, O, t, r);
            if (!$) return;
            E.push($);
            break;
          default:
      ...
      if (d === void 0 && m === void 0 && E.length === 0) {
        this._parserContext.log.addMessageForTokenSequence(
          v.MissingReference,
      ...
      return new Vn({
        ...
        importPathExcerpt: m,
        importHashExcerpt: _,
        spacingAfterImportHashExcerpt: w,
        memberReferences: E,
      });
    }),
    (n.prototype._parseMemberReference = function (e, t, r, i) {
      ...
      if (
        (e.peekTokenKind() === u.LeftParenthesis &&
          ...
          (o.spacingAfterLeftParenthesisExcerpt = this._tryReadSpacingAndNewlines(e))),
        e.peekTokenKind() === u.LeftSquareBracket)
      ) {
        if (((o.memberSymbol = this._parseMemberSymbol(e, i)), !o.memberSymbol)) return;
      } else if (((o.memberIdentifier = this._parseMemberIdentifier(e, r, i)), !o.memberIdentifier))
        return;
      if (
        ...
        if (((o.selector = this._parseMemberSelector(e, o.colonExcerpt, i)), !o.selector)) return;
      ...
      if (o.leftParenthesisExcerpt) {
        ...
        e.readToken(),
          ...
          (o.spacingAfterRightParenthesisExcerpt = this._tryReadSpacingAndNewlines(e));
      }
      return new tr(o);
    }),
    (n.prototype._parseMemberSymbol = function (e, t) {
      if (e.peekTokenKind() !== u.LeftSquareBracket) throw new Error('Expecting "["');
      e.readToken();
      var r = e.extractAccumulatedSequence(),
    ...
    (n.prototype._parseHtmlStartTag = function (e) {
      ...
      var t = e.createMarker(),
        r = e.readToken();
      if (r.kind !== u.LessThan) throw new Error('Expecting an HTML tag starting with "<"');
      var i = e.extractAccumulatedSequence(),
        o = this._parseHtmlName(e);
      if (yn(o)) return this._backtrackAndCreateErrorForFailure(e, t, 'Invalid HTML element: ', o);
      for (
      ...
      if (
        ...
        var _ = this._createFailureForTokensSince(
          e,
    ...
    (n.prototype._parseHtmlEndTag = function (e) {
      ...
      if (yn(a))
        return this._backtrackAndCreateErrorForFailure(e, t, 'Expecting an HTML element name: ', a);
    ...
    (n.prototype._parseHtmlName = function (e) {
      ...
      if (!i) return this._createFailureForToken(e, v.MalformedHtmlName, 'Expecting an HTML name');
      var o = i.toString(),
    ...
    (n.prototype._parseFencedCode = function (e) {
      ...
      var i = '';
      if (((i += e.readToken()), (i += e.readToken()), (i += e.readToken()), i !== '```'))
        throw new Error('Expecting three backticks');
      for (var o = e.extractAccumulatedSequence(); e.peekTokenKind() === u.Spacing; ) e.readToken();
      ...
      var _ = e.extractAccumulatedSequence(),
        w = _.getNewSequence(_.startIndex, c),
        b = _.getNewSequence(c, _.endIndex),
        S = -1,
        k = -1;
      l = !1;
      for (var E; !l; )
        switch (e.peekTokenKind()) {
          ...
          case u.Newline:
            for (E = e.readToken(), S = e.createMarker(); e.peekTokenKind() === u.Spacing; )
              E = e.readToken();
            if (
              e.peekTokenKind() !== u.Backtick ||
              ((k = e.createMarker()), e.readToken(), e.peekTokenKind() !== u.Backtick) ||
      ...
      var O = e.extractAccumulatedSequence(),
        $ = O.getNewSequence(O.startIndex, S),
        K = O.getNewSequence(S, k),
        D = O.getNewSequence(k, O.endIndex);
      for (l = !1; !l; )
        switch (e.peekTokenKind()) {
          case u.Spacing:
            e.readToken();
      ...
      return new Jn({
        ...
        languageExcerpt: w,
        spacingAfterLanguageExcerpt: b,
        codeExcerpt: $,
        spacingBeforeClosingFenceExcerpt: K,
        closingFenceExcerpt: D,
    ...
    (n.prototype._parseCodeSpan = function (e) {
      ...
      for (var r = e.extractAccumulatedSequence(), i = void 0, o = void 0; ; ) {
        ...
        if (a === u.Backtick) {
          ...
          (i = e.extractAccumulatedSequence()), e.readToken(), (o = e.extractAccumulatedSequence());
          break;
        }
    ...
    (n.prototype._backtrackAndCreateErrorRangeForFailure = function (e, t, r, i, o) {
      for (e.backtrackToMarker(t); e.createMarker() !== r; ) e.readToken();
      e.peekTokenKind() !== u.EndOfInput && e.readToken();
      var a = e.extractAccumulatedSequence(),
        l = new Pt({
    ...
    (n.prototype._createFailureForToken = function (e, t, r, i) {
      i || (i = e.createMarker());
      var o = new yt({ parserContext: this._parserContext, startIndex: i, endIndex: i + 1 });
    ...
    (n.prototype._createFailureForTokensSince = function (e, t, r, i) {
      ...
      o === i && ++o;
      var a = new yt({ parserContext: this._parserContext, startIndex: i, endIndex: o });
...
var oo = (function () {
  ...
  return (
    (n.splitParagraphs = function (e) {
      if (e instanceof xt) n.splitParagraphsForSection(e);
      else
    ...
    (n._splitParagraph = function (e, t) {
      var r = e.nodes,
        i = new st({ configuration: e.configuration });
      t.push(i);
      var o;
      (function (w) {
        (w[(w.Start = 0)] = 'Start'),
          (w[(w.AwaitingTrailer = 1)] = 'AwaitingTrailer'),
          (w[(w.ReadingTrailer = 2)] = 'ReadingTrailer');
      })(o || (o = {}));
      for (var a = o.Start, l = 0; l < r.length; ) {
        ...
        for (var _ = l; _ < d; ++_) i.appendNode(r[_]);
        l = d;
      }
    }),
...
var Rr = (function () {
  function n(e) {
    e ? (this.configuration = e) : (this.configuration = new Br());
  }
  return (
    (n.prototype.parseString = function (e) {
      return this.parseRange(ze.fromString(e));
    }),
    (n.prototype.parseRange = function (e) {
      var t = new $r(this.configuration, e);
      if (ro.extract(t)) {
        t.tokens = xn.readTokens(t.lines);
        var r = new io(t);
        r.parse(), oo.splitParagraphs(t.docComment);
      }
      return t;
    }),
    n
...
var ao = X(require('obsidian')),
  Yr = class extends ao.TFile {
    constructor(e) {
...
function rs(n, e) {
  ...
  if (!t) throw new P(`Folder "${e}" doesn't exist`);
...
function Mt(n, e) {
  ...
  if (!(t instanceof Te.TFile)) throw new P(`${e} is a folder, not a file`);
  return t;
}
function Je(n, e) {
  let t = rs(n, e),
    r = [];
  return (
    Te.Vault.recurseChildren(t, (i) => {
      i instanceof Te.TFile && r.push(i);
    }),
...
function is(n, e) {
  let r = new Rr().parseString(e),
    i = new Yr(n);
  return (
    (i.description = os(r.docComment.summarySection)),
    (i.returns = as(r.docComment.returnsBlock)),
    (i.arguments = ss(r.docComment.params)),
    i
  );
}
function os(n) {
...
function Gr(n, e, t) {
  ...
  return i.appendChild(o), i.appendChild(document.createTextNode(`: ${t}`)), i;
}
function ur(n, e) {
      ...
      if (e.hasOwnProperty(t))
        if (n.hasOwnProperty(t)) {
          ...
          if (Array.isArray(r) || Array.isArray(i)) {
            ...
            n[t] = o.concat(a).unique();
          } else jn(r) && jn(i) ? ur(r, i) : i != null && i !== '' && (n[t] = i);
        } else n[t] = e[t];
  }
}
function vn(n) {
  let e = {},
    t = (0, Te.getFrontMatterInfo)(n);
  return (
    t.frontmatter && (e = (0, Te.parseYaml)(t.frontmatter)),
    { frontmatter: e, content: n.slice(t.contentStart) }
  );
}
var Bo = X(require('obsidian'));
var Mo = X(require('obsidian'));
var ie = 'top',
  ue = 'bottom',
  ce = 'right',
  ae = 'left',
  ...
  Zt = 'popper',
  fo = 'reference',
  Wr = wt.reduce(function (n, e) {
    return n.concat([e + '-' + pt, e + '-' + Bt]);
  }, []),
  mr = [].concat(wt, [fr]).reduce(function (n, e) {
    return n.concat([e, e + '-' + pt, e + '-' + Bt]);
  }, []),
  cs = 'beforeRead',
  ls = 'read',
  ps = 'afterRead',
...
function Oe(n, e, t) {
  ...
  e &&
    fe(n) &&
    ((i = (n.offsetWidth > 0 && ut(r.width) / n.offsetWidth) || 1),
    (o = (n.offsetHeight > 0 && ut(r.height) / n.offsetHeight) || 1));
  var a = Me(n) ? Z(n) : window,
    l = a.visualViewport,
    c = !wn() && t,
    ...
    _ = r.width / i,
    w = r.height / o;
  return { width: _, height: w, top: m, right: d + _, bottom: m + w, left: d, x: d, y: m };
}
function Ft(n) {
  var e = Oe(n),
    t = n.offsetWidth,
...
function Ae(n) {
  return ((Me(n) ? n.ownerDocument : n.document) || window.document).documentElement;
}
function ft(n) {
  return me(n) === 'html' ? n : n.assignedSlot || n.parentNode || (en(n) ? n.host : null) || Ae(n);
}
function ho(n) {
...
function Le(n) {
  for (var e = Z(n), t = ho(n); t && Vr(t) && we(t).position === 'static'; ) t = ho(t);
  return t && (me(t) === 'html' || (me(t) === 'body' && we(t).position === 'static'))
    ? e
    : t || xs(n) || e;
}
function qt(n) {
...
function js(n) {
  var e,
    ...
    m = d ? 'height' : 'width';
  if (!(!o || !a)) {
    var _ = ys(i.padding, t),
      w = Ft(o),
      b = c === 'y' ? ie : ae,
      S = c === 'y' ? ue : ce,
      k = t.rects.reference[m] + t.rects.reference[c] - a[c] - t.rects.popper[m],
      E = a[c] - t.rects.reference[c],
      O = Le(o),
      $ = O ? (c === 'y' ? O.clientHeight || 0 : O.clientWidth || 0) : 0,
      K = k / 2 - E / 2,
      D = _[b],
      H = $ - w[m] - _[S],
      F = $ / 2 - w[m] / 2 + K,
...
function bs(n, e) {
  ...
  return { x: ut(t * i) / i || 0, y: ut(r * i) / i || 0 };
}
function xo(n) {
  var e,
    t = n.popper,
    ...
    S = a.y,
    k = S === void 0 ? 0 : S,
    E = typeof m == 'function' ? m({ x: b, y: k }) : { x: b, y: k };
  (b = E.x), (k = E.y);
  ...
  if (d) {
    ...
    if (i === ae || ((i === ie || i === ue) && o === Bt)) {
      K = ce;
      var Q = _ && F === H && H.visualViewport ? H.visualViewport.width : F[te];
      (b -= Q - r.width), (b *= c ? 1 : -1);
    }
  }
  var h = Object.assign({ position: l }, d && ws),
    C = m === !0 ? bs({ x: b, y: k }, Z(t)) : { x: b, y: k };
  if (((b = C.x), (k = C.y), c)) {
    var f;
  ...
  return Object.assign(
    {},
    h,
    ((e = {}), (e[D] = $ ? k + 'px' : ''), (e[K] = O ? b + 'px' : ''), (e.transform = ''), e),
  );
}
function Es(n) {
  var e = n.state,
...
var yo = { name: 'computeStyles', enabled: !0, phase: 'beforeWrite', fn: Es, data: {} };
var gr = { passive: !0 };
function Ts(n) {
  var e = n.state,
    t = n.instance,
  ...
  return (
    o &&
      d.forEach(function (m) {
        m.addEventListener('scroll', t.update, gr);
      }),
    l && c.addEventListener('resize', t.update, gr),
    function () {
      o &&
        d.forEach(function (m) {
          m.removeEventListener('scroll', t.update, gr);
        }),
...
function $t(n) {
  return Oe(Ae(n)).left + Ht(n).scrollLeft;
}
function zr(n, e) {
  var t = Z(n),
    r = Ae(n),
  ...
  return { width: o, height: a, x: l + $t(n), y: c };
}
function Jr(n) {
  var e,
    t = Ae(n),
    ...
    o = qe(t.scrollWidth, t.clientWidth, i ? i.scrollWidth : 0, i ? i.clientWidth : 0),
    a = qe(t.scrollHeight, t.clientHeight, i ? i.scrollHeight : 0, i ? i.clientHeight : 0),
    l = -r.scrollLeft + $t(n),
    c = -r.scrollTop;
  return (
    we(i || t).direction === 'rtl' && (l += qe(t.clientWidth, i ? i.clientWidth : 0) - o),
...
function vo(n, e, t) {
  return e === dr ? rn(zr(n, t)) : Me(e) ? Cs(e, t) : rn(Jr(Ae(n)));
}
function Ds(n) {
  var e = bt(ft(n)),
  ...
  return Me(r)
    ? e.filter(function (i) {
        return Me(i) && bn(i, r) && me(i) !== 'body';
      })
    : [];
}
function Qr(n, e, t, r) {
  var i = e === 'clippingParents' ? Ds(n) : [].concat(e),
    o = [].concat(i, [t]),
    a = o[0],
    l = o.reduce(
      function (c, d) {
...
function He(n, e) {
  ...
  var t = e,
    ...
    k = t.padding,
    E = k === void 0 ? 0 : k,
    O = Tn(typeof E != 'number' ? E : kn(E, wt)),
    $ = w === Zt ? fo : Zt,
    K = n.rects.popper,
    D = n.elements[S ? $ : w],
    H = Qr(Me(D) ? D : D.contextElement || Ae(n.elements.popper), c, m, a),
    F = Oe(n.elements.reference),
    J = Sn({ reference: F, element: K, strategy: 'absolute', placement: i }),
...
function Xr(n, e) {
  ...
  w.length === 0 && (w = _);
  var b = w.reduce(function (S, k) {
    return (S[k] = He(n, { placement: k, boundary: i, rootBoundary: o, padding: a })[ge(k)]), S;
  }, {});
  return Object.keys(b).sort(function (S, k) {
    return b[S] - b[k];
  });
}
function Ps(n) {
  ...
  if (!e.modifiersData[r]._skip) {
    for (
      ...
      var h = D[Q],
        C = ge(h),
        f = Be(h) === pt,
        Ie = [ie, ue].indexOf(C) >= 0,
        Ee = Ie ? 'width' : 'height',
        _e = He(e, { placement: h, boundary: m, rootBoundary: _, altBoundary: w, padding: d }),
        ...
        var Yt = S ? 3 : 1,
          Ue = function (N) {
            var q = D.find(function (ee) {
              var tt = J.get(ee);
              if (tt)
                return tt.slice(0, N).every(function (W) {
                  return W;
                });
            });
    ...
    e.placement !== ne && ((e.modifiersData[r]._skip = !0), (e.placement = ne), (e.reset = !0));
  }
}
var wo = {
  name: 'flip',
...
function Ms(n) {
  var e = n.state,
    ...
    a = He(e, { elementContext: 'reference' }),
    l = He(e, { altBoundary: !0 }),
    c = bo(a, r),
    d = bo(l, i, o),
    m = Eo(c),
    _ = Eo(d);
...
function Os(n, e, t) {
  var r = ge(n),
    ...
    l = o[1];
  return (
    (a = a || 0), (l = (l || 0) * i), [ae, ce].indexOf(r) >= 0 ? { x: l, y: a } : { x: a, y: l }
  );
}
function Bs(n) {
  var e = n.state,
    ...
    i = t.offset,
    o = i === void 0 ? [0, 0] : i,
    a = mr.reduce(function (m, _) {
      return (m[_] = Os(_, e.rects, o)), m;
    }, {}),
    l = a[e.placement],
    c = l.x,
    d = l.y;
  e.modifiersData.popperOffsets != null &&
    ((e.modifiersData.popperOffsets.x += c), (e.modifiersData.popperOffsets.y += d)),
    (e.modifiersData[r] = a);
}
var ko = { name: 'offset', enabled: !0, phase: 'main', requires: ['popperOffsets'], fn: Bs };
function Is(n) {
  var e = n.state,
    t = n.name;
...
var So = { name: 'popperOffsets', enabled: !0, phase: 'read', fn: Is, data: {} };
function Zr(n) {
  return n === 'x' ? 'y' : 'x';
}
function Fs(n) {
  var e = n.state,
    ...
    S = t.tetherOffset,
    k = S === void 0 ? 0 : S,
    E = He(e, { boundary: c, rootBoundary: d, padding: _, altBoundary: m }),
    O = ge(e.placement),
    $ = Be(e.placement),
    K = !$,
    D = qt(O),
    ...
    J = e.rects.reference,
    te = e.rects.popper,
    ne = typeof k == 'function' ? k(Object.assign({}, e.rects, { placement: e.placement })) : k,
    Q =
      typeof ne == 'number'
  ...
  if (!!F) {
    if (o) {
      var f,
        ...
        ee = N[Ee],
        tt = Lt(0, J[_e], B[_e]),
        W = K ? J[_e] / 2 - Yt - tt - q - Q.mainAxis : Ue - tt - q - Q.mainAxis,
        je = K ? -J[_e] / 2 + Yt + tt + ee + Q.mainAxis : et + tt + ee + Q.mainAxis,
        kt = e.elements.arrow && Le(e.elements.arrow),
        Mn = kt ? (D === 'y' ? kt.clientTop || 0 : kt.clientLeft || 0) : 0,
        nt = (f = h == null ? void 0 : h[D]) != null ? f : 0,
        rt = xe + W - nt - Mn,
        ht = xe + je - nt,
        St = Lt(b ? It(Ye, rt) : Ye, xe, b ? qe(ke, ht) : ke);
      (F[D] = St), (C[D] = St - xe);
    }
    if (l) {
      var On,
        ...
        Fn = it + E[Bn],
        qn = it - E[In],
        pn = [ie, ae].indexOf(O) !== -1,
        Ct = (On = h == null ? void 0 : h[H]) != null ? On : 0,
        Ln = pn ? Fn : it - J[Ut] - te[Ut] - Ct + Q.altAxis,
        Ge = pn ? it + J[Ut] + te[Ut] - Ct - Q.altAxis : qn,
        se = b && pn ? Ao(Ln, it, Ge) : Lt(b ? Ln : Fn, it, b ? Ge : qn);
      (F[H] = se), (C[H] = se - it);
    }
    e.modifiersData[r] = C;
  }
...
function ti(n) {
  return n === Z(n) || !fe(n) ? Ht(n) : ei(n);
}
function qs(n) {
  var e = n.getBoundingClientRect(),
    t = ut(e.width) / n.offsetWidth || 1,
    r = ut(e.height) / n.offsetHeight || 1;
  return t !== 1 || r !== 1;
}
function ni(n, e, t) {
  t === void 0 && (t = !1);
  ...
  return (
    (r || (!r && !t)) &&
      ((me(e) !== 'body' || Kt(o)) && (l = ti(e)),
      fe(e) ? ((c = Oe(e, !0)), (c.x += e.clientLeft), (c.y += e.clientTop)) : o && (c.x = $t(o))),
    {
...
function No(n) {
  ...
  return function (l, c, d) {
    ...
    var m = {
      ...
      b = {
        ...
        setOptions: function (O) {
          var $ = typeof O == 'function' ? O(m.options) : O;
          k(),
            (m.options = Object.assign({}, o, m.options, $)),
            (m.scrollParents = {
              reference: Me(l) ? bt(l) : l.contextElement ? bt(l.contextElement) : [],
              popper: bt(c),
            });
          var K = ri(oi([].concat(r, m.options.modifiers)));
          return (
            (m.orderedModifiers = K.filter(function (D) {
              return D.enabled;
            })),
            S(),
            b.update()
        ...
        forceUpdate: function () {
          if (!w) {
            ...
            if (!!Po($, K)) {
              (m.rects = {
                reference: ni($, Le(K), m.options.strategy === 'fixed'),
                popper: Ft(K),
              }),
                (m.reset = !1),
              ...
              for (var D = 0; D < m.orderedModifiers.length; D++) {
                if (m.reset === !0) {
                  (m.reset = !1), (D = -1);
                  continue;
                }
                var H = m.orderedModifiers[D],
                  F = H.fn,
                  J = H.options,
                  te = J === void 0 ? {} : J,
                  ne = H.name;
                typeof F == 'function' &&
                  (m = F({ state: m, options: te, name: ne, instance: b }) || m);
              }
            }
          }
        },
    ...
    if (!Po(l, c)) return b;
    b.setOptions(d).then(function (E) {
      !w && d.onFirstUpdate && d.onFirstUpdate(E);
    });
    function S() {
      m.orderedModifiers.forEach(function (E) {
        ...
        if (typeof D == 'function') {
          var H = D({ state: m, name: O, instance: b, options: K }),
            F = function () {};
          _.push(H || F);
        }
      });
...
var Hs = [jo, So, yo, go, ko, wo, Co, _o, To],
  ai = No({ defaultModifiers: Hs });
var $s = (n, e) => ((n % e) + e) % e,
  Oo = class {
    constructor(e, t, r) {
      (this.owner = e),
        ...
        r.register([], 'ArrowUp', (i) => {
          if (!i.isComposing) return this.setSelectedItem(this.selectedItem - 1, !0), !1;
        }),
    ...
    setSelectedItem(e, t) {
      let r = $s(e, this.suggestions.length),
  ...
  Cn = class {
    constructor(e, t) {
      (this.app = e),
        (this.inputEl = t),
        (this.scope = new Mo.Scope()),
        (this.suggestEl = createDiv('suggestion-container'));
      let r = this.suggestEl.createDiv('suggestion');
      (this.suggest = new Oo(this, r, this.scope)),
    ...
    open(e, t) {
      this.app.keymap.pushScope(this.scope),
        ...
        (this.popper = ai(t, this.suggestEl, {
          ...
          modifiers: [
            {
              ...
              fn: ({ state: r, instance: i }) => {
                ...
                r.styles.popper.width !== o && ((r.styles.popper.width = o), i.update());
              },
              phase: 'beforeWrite',
              requires: ['computeStyles'],
            },
...
var $e;
(function (t) {
  (t[(t.TemplateFiles = 0)] = 'TemplateFiles'), (t[(t.ScriptFiles = 1)] = 'ScriptFiles');
})($e || ($e = {}));
var on = class extends Cn {
  constructor(e, t, r) {
    super(t.app, e);
    this.inputEl = e;
    this.plugin = t;
  ...
  getSuggestions(e) {
    let t = Ce(
      () => Je(this.plugin.app, this.get_folder(this.mode)),
...
var Dn = class extends Cn {
  ...
  getSuggestions(e) {
    ...
    return (
      t.forEach((o) => {
        o instanceof Io.TFolder && o.path.toLowerCase().contains(i) && r.push(o);
      }),
      r.slice(0, 1e3)
    );
  }
...
(function (o) {
  (o[(o.Off = 0)] = 'Off'),
    (o[(o.RenderDescriptionParameterReturn = 1)] = 'RenderDescriptionParameterReturn'),
    (o[(o.RenderDescriptionParameterList = 2)] = 'RenderDescriptionParameterList'),
...
var Ho = {
    ...
    startup_templates: [''],
    intellisense_render: dt.RenderDescriptionParameterReturn,
  },
  si = class extends L.PluginSettingTab {
    constructor(e) {
      super(e.app, e);
      this.plugin = e;
      this.icon = 'templater-icon';
    }
    display() {
      this.containerEl.empty(),
        ...
        this.plugin.settings.trigger_on_file_creation &&
          (this.add_folder_templates_setting(), this.add_file_templates_setting()),
    ...
    add_internal_functions_setting() {
      ...
      e.append(
        ...
        new L.Setting(this.containerEl).setName('Internal variables and functions').setDesc(e);
    }
    add_syntax_highlighting_settings() {
      ...
      t.append(
        ...
        new L.Setting(this.containerEl)
          ...
          .setDesc(t)
          .addToggle((r) => {
            r.setValue(this.plugin.settings.syntax_highlighting_mobile).onChange((i) => {
        ...
        new L.Setting(this.containerEl)
          ...
          .addToggle((t) => {
            t.setValue(this.plugin.settings.auto_jump_to_cursor).onChange((r) => {
              (this.plugin.settings.auto_jump_to_cursor = r), this.plugin.save_settings();
            });
          });
    }
    add_trigger_on_new_file_creation_setting() {
      ...
      e.append(
        ...
        new L.Setting(this.containerEl)
          ...
          .setDesc(e)
          .addToggle((t) => {
            t.setValue(this.plugin.settings.trigger_on_file_creation).onChange((r) => {
            ...
            .addSearch((o) => {
              new on(o.inputEl, this.plugin, $e.TemplateFiles),
                o
                  ...
                  .setValue(t)
                  .onChange((a) => {
                    if (a && this.plugin.settings.enabled_templates_hotkeys.contains(a)) {
                      oe(new P('This template is already bound to a hotkey'));
                      return;
                    }
            ...
            .addExtraButton((o) => {
              o.setIcon('any-key')
                ...
                .onClick(() => {
                  ...
                  (a.searchComponent.inputEl.value = t), a.updateHotkeyVisibility();
                });
            })
            .addExtraButton((o) => {
              o.setIcon('up-chevron-glyph')
                .setTooltip('Move up')
                .onClick(() => {
                  Ot(this.plugin.settings.enabled_templates_hotkeys, r, r - 1),
                    this.plugin.save_settings(),
                    this.display();
                });
            })
    ...
    add_folder_templates_setting() {
      ...
      t.append(
        ...
        new L.Setting(this.containerEl)
          ...
          .setDesc(t)
          .addToggle((r) => {
            r.setValue(this.plugin.settings.enable_folder_templates).onChange((i) => {
        ...
        !!this.plugin.settings.enable_folder_templates &&
          (this.plugin.settings.folder_templates.forEach((r, i) => {
            new L.Setting(this.containerEl)
              .addSearch((a) => {
                new Dn(this.app, a.inputEl),
                  a
                    .setPlaceholder('Folder')
                    .setValue(r.folder)
                    .onChange((l) => {
                      if (l && this.plugin.settings.folder_templates.some((c) => c.folder == l)) {
                        oe(new P('This folder already has a template associated with it'));
                        return;
                      }
              ...
              .addExtraButton((a) => {
                a.setIcon('up-chevron-glyph')
                  .setTooltip('Move up')
                  .onClick(() => {
                    Ot(this.plugin.settings.folder_templates, i, i - 1),
                      this.plugin.save_settings(),
                      this.display();
                  });
              })
    ...
    add_file_templates_setting() {
      new L.Setting(this.containerEl).setName('File regex templates').setHeading();
      let e = document.createDocumentFragment();
      e.append(
      ...
      t.append(
        ...
        new L.Setting(this.containerEl)
          ...
          .setDesc(t)
          .addToggle((r) => {
            r.setValue(this.plugin.settings.enable_file_templates).onChange((i) => {
        ...
        !!this.plugin.settings.enable_file_templates &&
            ...
            new L.Setting(this.containerEl)
              .addText((a) => {
                a
                  ...
                  .setValue(r.regex)
                  .onChange((l) => {
                    (this.plugin.settings.file_templates[i].regex = l), this.plugin.save_settings();
                  }),
              ...
              .addExtraButton((a) => {
                a.setIcon('up-chevron-glyph')
                  .setTooltip('Move up')
                  .onClick(() => {
                    Ot(this.plugin.settings.file_templates, i, i - 1),
                      this.plugin.save_settings(),
                      this.display();
                  });
              })
          ...
          new L.Setting(this.containerEl).addButton((r) => {
            r.setButtonText('Add new file regex')
              ...
              .setCta()
              .onClick(() => {
                this.plugin.settings.file_templates.push({ regex: '', template: '' }),
                  this.plugin.save_settings(),
                  this.display();
              });
          }));
            ...
            .addSearch((o) => {
              new on(o.inputEl, this.plugin, $e.TemplateFiles),
                o
                  ...
                  .setValue(t)
                  .onChange((a) => {
                    if (a && this.plugin.settings.startup_templates.contains(a)) {
                      oe(new P('This startup template already exist'));
                      return;
                    }
                    (this.plugin.settings.startup_templates[r] = a), this.plugin.save_settings();
                  }),
                o.containerEl.addClass('templater_search');
            })
            .addExtraButton((o) => {
    ...
    add_user_script_functions_setting() {
      new L.Setting(this.containerEl).setName('User script functions').setHeading();
      let e = document.createDocumentFragment();
      e.append(
        ...
        new L.Setting(this.containerEl)
          ...
          .setDesc(e)
          .addSearch((r) => {
            new Dn(this.app, r.inputEl),
              r
                .setPlaceholder('Example: folder1/folder2')
                .setValue(this.plugin.settings.user_scripts_folder)
                .onChange((i) => {
                  (this.plugin.settings.user_scripts_folder = i), this.plugin.save_settings();
                }),
      ...
      let t;
      if (!this.plugin.settings.user_scripts_folder) t = 'No user scripts folder set';
      else {
        let r = Ce(
          () => Je(this.app, this.plugin.settings.user_scripts_folder),
        ...
        if (!r || r.length === 0) t = 'No user scripts detected';
          ...
          for (let o of r)
            o.extension === 'js' &&
              (i++, e.append(e.createEl('li', { text: `tp.user.${o.basename}` })));
    ...
    add_user_system_command_functions_setting() {
      ...
      if (
        ...
        new L.Setting(this.containerEl).setName('User system command functions').setHeading(),
        new L.Setting(this.containerEl)
          .setName('Enable user system command functions')
          .setDesc(e)
          .addToggle((t) => {
            t.setValue(this.plugin.settings.enable_system_commands).onChange((r) => {
          ...
          .addText((o) => {
            o.setPlaceholder('Timeout')
              ...
              .onChange((a) => {
                let l = Number(a);
                if (isNaN(l)) {
                  oe(new P('Timeout must be a number'));
                  return;
                }
                (this.plugin.settings.command_timeout = l), this.plugin.save_settings();
              });
          }),
          (e = document.createDocumentFragment()),
          e.append(
          ...
          new L.Setting(this.containerEl)
            ...
            .addText((o) => {
              o.setPlaceholder('Example: /bin/bash, ...')
                ...
                .onChange((a) => {
                  (this.plugin.settings.shell_path = a), this.plugin.save_settings();
                });
            });
        let t = 1;
        this.plugin.settings.templates_pairs.forEach((o) => {
          ...
          let l = this.containerEl.createEl('h4', { text: 'User function n\xB0' + t });
            ...
            new L.Setting(this.containerEl)
              ...
              .addText((d) => {
                let m = d
                  ...
                  .setValue(o[0])
                  .onChange((_) => {
                    let w = this.plugin.settings.templates_pairs.indexOf(o);
                    w > -1 &&
                      ((this.plugin.settings.templates_pairs[w][0] = _),
                      this.plugin.save_settings());
                  });
              ...
              .addTextArea((d) => {
                let m = d
                  ...
                  .onChange((_) => {
                    let w = this.plugin.settings.templates_pairs.indexOf(o);
                    w > -1 &&
                      ((this.plugin.settings.templates_pairs[w][1] = _),
                      this.plugin.save_settings());
                  });
                return m.inputEl.setAttr('rows', 2), m.inputEl.addClass('templater_cmd'), m;
              })
              .infoEl.remove(),
            a.appendChild(l),
    ...
    add_donating_setting() {
      ...
      i.setAttribute('href', 'https://www.paypal.com/donate?hosted_button_id=U2SRGAFYXT32Q'),
        i.addClass('templater_donating');
      let o = document.createElement('img');
      (o.src = 'https://img.shields.io/badge/paypal-silentvoid13-yellow?style=social&logo=paypal'),
        i.appendChild(o),
        e.settingEl.appendChild(t),
        e.settingEl.appendChild(i);
    }
  };
var _r = X(require('obsidian'));
var an;
(function (t) {
  (t[(t.InsertTemplate = 0)] = 'InsertTemplate'),
    (t[(t.CreateNoteTemplate = 1)] = 'CreateNoteTemplate');
})(an || (an = {}));
var ci = class extends _r.FuzzySuggestModal {
  constructor(e) {
    super(e.app);
    (this.plugin = e), this.setPlaceholder('Type name of a template...');
  }
  getItems() {
    if (!this.plugin.settings.templates_folder) return this.app.vault.getMarkdownFiles();
    let e = Ce(
      () => Je(this.plugin.app, this.plugin.settings.templates_folder),
  ...
  getItemText(e) {
    ...
    if (
      ...
      (0, _r.normalizePath)(this.plugin.settings.templates_folder) != '/'
    ) {
  ...
  onChooseItem(e) {
    switch (this.open_mode) {
      case 0:
        ...
        break;
      case 1:
        this.plugin.templater.create_new_note_from_template(e, this.creation_folder);
        break;
    }
  }
  start() {
...
var $o = 'Error_MobileUnsupportedTemplate',
  Ko =
...
var de = X(require('obsidian'));
var mt = X(require('obsidian'));
var be = class {
  constructor(e) {
    this.plugin = e;
...
var li = class extends be {
  ...
  generate_now() {
    return (e = 'YYYY-MM-DD', t, r, i) => {
      ...
      return (
        typeof t == 'string'
          ? (o = mt.moment.duration(t))
          : typeof t == 'number' && (o = mt.moment.duration(t, 'days')),
        (0, mt.moment)(r, i).add(o).format(e)
      );
    };
  }
  generate_tomorrow() {
    return (e = 'YYYY-MM-DD') => (0, mt.moment)().add(1, 'days').format(e);
  }
  generate_weekday() {
    return (e = 'YYYY-MM-DD', t, r, i) => {
      if (r && !(0, mt.moment)(r, i).isValid())
      ...
      return (0, mt.moment)(r, i).weekday(t).format(e);
    };
  }
  generate_yesterday() {
    return (e = 'YYYY-MM-DD') => (0, mt.moment)().add(-1, 'days').format(e);
  ...
  pi = class extends be {
    ...
    generate_create_new() {
      return async (e, t, r = !1, i) => {
        if (((this.create_new_depth += 1), this.create_new_depth > Ro))
          throw ((this.create_new_depth = 0), new P('Reached create_new depth limit (max = 10)'));
        let o = await this.plugin.templater.create_new_note_from_template(e, i, t, r);
    ...
    generate_cursor_append() {
      return (e) => {
        ...
        if (!t || !t.editor) {
          oe(new P("No active editor, can't append to cursor."));
          return;
        }
    ...
    generate_include() {
      return async (e) => {
        if (((this.include_depth += 1), this.include_depth > Ro))
          throw ((this.include_depth -= 1), new P('Reached inclusion depth limit (max = 10)'));
        let t;
        if (e instanceof le.TFile) t = await this.plugin.app.vault.read(e);
          ...
          if ((r = this.linkpath_regex.exec(e)) === null)
            throw (
              ...
              new P('Invalid file format, provide an obsidian link between quotes.'))
            );
          let { path: i, subpath: o } = (0, le.parseLinktext)(r[1]),
            a = this.plugin.app.metadataCache.getFirstLinkpathDest(i, '');
          if (!a) throw ((this.include_depth -= 1), new P(`File ${e} doesn't exist`));
    ...
    generate_path() {
      return (e = !1) => {
        ...
        if (le.Platform.isMobile) {
          ...
          t = `${r}/${i}`;
        } else if (this.plugin.app.vault.adapter instanceof le.FileSystemAdapter)
          t = this.plugin.app.vault.adapter.getBasePath();
        else throw new P('app.vault is not a FileSystemAdapter instance');
        return e ? this.config.target_file.path : `${t}/${this.config.target_file.path}`;
      };
    }
    generate_rename() {
      return async (e) => {
        if (e.match(/[\\/:]+/g))
          throw new P('File name cannot contain any of these characters: \\ / :');
        let t = (0, le.normalizePath)(
          `${this.config.target_file.parent.path}/${e}.${this.config.target_file.extension}`,
        );
        return await this.plugin.app.fileManager.renameFile(this.config.target_file, t), '';
      };
    }
    generate_selection() {
      return () => {
        let e = this.plugin.app.workspace.activeEditor;
        if (!e || !e.editor) throw new P("Active editor is null, can't read selection.");
...
var Yo = X(require('obsidian'));
var ui = class extends be {
  constructor() {
    super(...arguments);
    this.name = 'web';
  }
  ...
  async getRequest(e) {
    try {
      let t = await (0, Yo.requestUrl)(e);
      if (t.status < 200 && t.status >= 300) throw new P('Error performing GET request');
      return t;
    } catch {
      throw new P('Error performing GET request');
    }
  }
...
> \u2014 ${o}`;
        ...
        return new P('Error generating daily quote'), 'Error generating daily quote';
      }
    };
  }
  generate_random_picture() {
    return async (e, t, r = !1) => {
      try {
        ...
        return new P('Error generating random picture'), 'Error generating random picture';
      }
    };
  }
  generate_request() {
    return async (e, t) => {
      try {
        ...
        throw (console.error(r), new P('Error fetching and extracting value'));
      }
    };
  }
};
var fi = class extends be {
  ...
  generate_on_all_templates_executed() {
    return (e) => {
      let t = this.plugin.app.workspace.on('templater:all-templates-executed', async () => {
        await jt(1), e();
      });
...
var Qe = X(require('obsidian'));
var mi = class extends Qe.Modal {
  constructor(e, t, r, i) {
    super(e);
    this.prompt_text = t;
  ...
  onClose() {
    this.contentEl.empty(), this.submitted || this.reject(new P('Cancelled prompt'));
  }
  createForm() {
    let e = this.contentEl.createDiv();
    e.addClass('templater-prompt-div');
    let t;
    this.multi_line ? (t = new Qe.TextAreaComponent(e)) : (t = new Qe.TextComponent(e));
    let r = this.contentEl.createDiv();
    r.addClass('templater-button-div');
    let i = new Qe.ButtonComponent(r);
  ...
  enterCallback(e) {
    e.isComposing ||
      e.keyCode === 229 ||
      (this.multi_line
        ? Qe.Platform.isDesktop && e.key === 'Enter' && !e.shiftKey && this.resolveAndClose(e)
        : e.key === 'Enter' && this.resolveAndClose(e));
  }
  resolveAndClose(e) {
    (this.submitted = !0), e.preventDefault(), this.resolve(this.value), this.close();
  }
  async openAndGetValue(e, t) {
    (this.resolve = e), (this.reject = t), this.open();
  }
};
var Uo = X(require('obsidian')),
  gi = class extends Uo.FuzzySuggestModal {
    ...
    onClose() {
      this.submitted || this.reject(new P('Cancelled prompt'));
    }
...
var De = X(require('obsidian')),
  hi = class extends De.Modal {
    constructor(e, t, r, i, o) {
      ...
      this.submitted = !1;
      this.selectedItems = [];
      this.setTitle(i), (this.listEl = this.contentEl.createDiv('templater-multisuggester-list'));
      let a = this.contentEl.createDiv('templater-multisuggester-div'),
        l = new De.TextComponent(a);
      l.inputEl.addClass('templater-multisuggester-input'),
        (this.suggester = new Go(e, l.inputEl, this.getItemText.bind(this), r, o).onSelect(
          this.onChooseItem.bind(this),
        ));
      let c = this.contentEl.createDiv('modal-button-container');
      new De.ButtonComponent(c)
        .setButtonText('Save')
        .setCta()
        .onClick(() => this.save()),
        new De.ButtonComponent(c).setButtonText('Cancel').onClick(() => this.close());
    }
    onOpen() {
      this.display();
    }
    display() {
      this.listEl.empty(),
        this.selectedItems.forEach((e) => {
          let t = this.listEl.createDiv('mobile-option-setting-item');
          t.createSpan('mobile-option-setting-item-name').setText(this.getItemText(e)),
            t.createDiv('clickable-icon mobile-option-setting-item-option-icon', (r) => {
              (0, De.setIcon)(r, 'lucide-x'),
    ...
    onChooseItem(e) {
      ...
      let t = this.items.filter((r) => !this.selectedItems.some((i) => i === r));
      this.suggester.setItems(t), this.display();
    }
    onRemoveItem(e) {
      this.selectedItems = this.selectedItems.filter((r) => r !== e);
      let t = this.items.filter((r) => !this.selectedItems.some((i) => i === r));
      this.suggester.setItems(t), this.display();
    }
    save() {
      (this.submitted = !0), this.close(), this.resolve(this.selectedItems);
    }
    onClose() {
      this.submitted || this.reject(new P('Cancelled prompt'));
    }
  ...
  Go = class extends De.AbstractInputSuggest {
    constructor(e, t, r, i, o) {
      super(e, t);
      this.getItemText = r;
      this.items = i;
    ...
    getSuggestions(e) {
      let t = (0, De.prepareFuzzySearch)(e);
      return this.items.reduce((r, i) => {
        let o = this.getItemText(i);
        return t(o) && r.push(i), r;
      }, []);
    }
    renderSuggestion(e, t) {
      t.createDiv('suggestion-content').setText(this.getItemText(e));
    }
    setItems(e) {
      this.items = e;
    }
    selectSuggestion(e, t) {
      this.setValue(''), this.close(), super.selectSuggestion(e, t);
    }
  };
var Ai = class extends be {
  ...
  generate_prompt() {
    return async (e, t, r = !1, i = !1) => {
      let o = new mi(this.plugin.app, e, t, i),
  ...
  generate_suggester() {
    return async (e, t, r = !1, i = '', o) => {
      let a = new gi(this.plugin.app, e, t, i, o),
  ...
  generate_multi_suggester() {
    return async (e, t, r = !1, i = '', o) => {
      let a = new hi(this.plugin.app, e, t, i, o),
        l = new Promise((c, d) => a.openAndGetValue(c, d));
      try {
        return await l;
      } catch (c) {
...
var xi = class {
  constructor(e) {
    ...
    this.modules_array.push(new li(this.plugin)),
      this.modules_array.push(new pi(this.plugin)),
      this.modules_array.push(new ui(this.plugin)),
      ...
      this.modules_array.push(new _i(this.plugin));
  }
  async init() {
  ...
  async generate_object(e) {
    let t = {};
    for (let r of this.modules_array) t[r.getName()] = await r.generate_object(e);
    return t;
  }
};
var Pn = X(require('obsidian'));
var yi = class {
  constructor(e) {
    this.plugin = e;
    if (Pn.Platform.isMobile || !(this.plugin.app.vault.adapter instanceof Pn.FileSystemAdapter))
      this.cwd = '';
    else {
  ...
  async generate_system_functions(e) {
    let t = new Map(),
      r = await this.plugin.templater.functions_generator.generate_object(e, Xe.INTERNAL);
    for (let i of this.plugin.settings.templates_pairs) {
      let o = i[0],
        a = i[1];
      !o ||
        !a ||
        (Pn.Platform.isMobile
          ? t.set(o, () => new Promise((l) => l($o)))
          : ((a = await this.plugin.templater.parser.parse_commands(a, r)),
            t.set(o, async (l) => {
              ...
              try {
                ...
                throw new P(`Error with User Template ${o}`, m);
              }
            })));
    }
    return t;
...
var ji = class {
  ...
  async generate_user_script_functions() {
    let e = new Map(),
      t = Ce(
        () => Je(this.plugin.app, this.plugin.settings.user_scripts_folder),
        `Couldn't find user script folder "${this.plugin.settings.user_scripts_folder}"`,
      );
    if (!t) return new Map();
    for (let r of t)
      r.extension.toLowerCase() === 'js' && (await this.load_user_script_function(r, e));
    return e;
  }
  async load_user_script_function(e, t) {
    ...
    try {
      ...
      throw new P(`Failed to load user script at "${e.path}".`, c.message);
    }
    let l = i.default ?? o.exports;
    if (!l) throw new P(`Failed to load user script at "${e.path}". No exports detected.`);
    if (typeof l == 'function') t.set(e.basename, l);
    else if (typeof l == 'object' && l !== null) {
      if (!Object.values(l).every((d) => typeof d == 'function'))
        throw new P(`Exported object in "${e.path}" must contain only functions.`);
      t.set(e.basename, l);
    } else throw new P(`Invalid export in "${e.path}". Must be a function or object of functions.`);
  }
...
var vi = class {
  constructor(e) {
    this.plugin = e;
    (this.user_system_functions = new yi(e)), (this.user_script_functions = new ji(e));
  }
  async generate_object(e) {
    let t = {},
      r = {};
...
var Ks = X(require('obsidian')),
  Xe;
(function (t) {
  (t[(t.INTERNAL = 0)] = 'INTERNAL'), (t[(t.USER_INTERNAL = 1)] = 'USER_INTERNAL');
})(Xe || (Xe = {}));
var wi = class {
  constructor(e) {
    this.plugin = e;
    (this.internal_functions = new xi(this.plugin)), (this.user_functions = new vi(this.plugin));
  }
  async init() {
  ...
  additional_functions() {
    return { app: this.plugin.app, obsidian: Ks };
  }
  async generate_object(e, t = 1) {
    ...
    switch ((Object.assign(r, i), t)) {
      case 0:
        ...
        break;
      case 1:
        (a = await this.user_functions.generate_object(e)), Object.assign(r, { ...o, user: a });
        break;
    }
    return r;
  }
...
var Wo = new TextDecoder('utf-8', { ignoreBOM: !0, fatal: !0 });
Wo.decode();
var xr = new Uint8Array();
function yr() {
  return xr.byteLength === 0 && (xr = new Uint8Array(M.memory.buffer)), xr;
}
function Et(n, e) {
  return Wo.decode(yr().subarray(n, n + e));
}
function Tt(n) {
  Nn === Ke.length && Ke.push(Ke.length + 1);
  let e = Nn;
  return (Nn = Ke[e]), (Ke[e] = n), e;
}
var Re = 0,
  jr = new TextEncoder('utf-8'),
  Ys =
    typeof jr.encodeInto == 'function'
      ? function (n, e) {
          return jr.encodeInto(n, e);
        }
      : function (n, e) {
          let t = jr.encode(n);
...
var vr = new Int32Array();
function Ne() {
  return vr.byteLength === 0 && (vr = new Int32Array(M.memory.buffer)), vr;
}
function Ei(n) {
  let e = typeof n;
...
var wr = 32;
function Ws(n) {
  if (wr == 1) throw new Error('out of js stack');
  return (Ke[--wr] = n), wr;
}
function Ti(n, e) {
  try {
    ...
    M.__wbindgen_exn_store(Tt(t));
  }
}
var Rt = class {
    static __wrap(e) {
      let t = Object.create(Rt.prototype);
      return (t.ptr = e), t;
    }
    __destroy_into_raw() {
      let e = this.ptr;
    ...
    free() {
      ...
      M.__wbg_parserconfig_free(e);
    }
    get interpolate() {
      let e = M.__wbg_get_parserconfig_interpolate(this.ptr);
      return String.fromCodePoint(e);
    }
    set interpolate(e) {
      M.__wbg_set_parserconfig_interpolate(this.ptr, e.codePointAt(0));
    }
    get execution() {
      let e = M.__wbg_get_parserconfig_execution(this.ptr);
      return String.fromCodePoint(e);
    }
    set execution(e) {
      M.__wbg_set_parserconfig_execution(this.ptr, e.codePointAt(0));
    }
    get single_whitespace() {
      let e = M.__wbg_get_parserconfig_single_whitespace(this.ptr);
      return String.fromCodePoint(e);
    }
    set single_whitespace(e) {
      M.__wbg_set_parserconfig_single_whitespace(this.ptr, e.codePointAt(0));
    }
    get multiple_whitespace() {
      let e = M.__wbg_get_parserconfig_multiple_whitespace(this.ptr);
      return String.fromCodePoint(e);
    }
    set multiple_whitespace(e) {
      M.__wbg_set_parserconfig_multiple_whitespace(this.ptr, e.codePointAt(0));
    }
    constructor(e, t, r, i, o, a, l) {
      let c = gt(e, M.__wbindgen_malloc, M.__wbindgen_realloc),
        d = Re,
        m = gt(t, M.__wbindgen_malloc, M.__wbindgen_realloc),
        _ = Re,
        w = gt(l, M.__wbindgen_malloc, M.__wbindgen_realloc),
        b = Re,
        S = M.parserconfig_new(
          c,
          d,
          m,
          _,
    ...
    get opening_tag() {
      try {
        let r = M.__wbindgen_add_to_stack_pointer(-16);
    ...
    set opening_tag(e) {
      let t = gt(e, M.__wbindgen_malloc, M.__wbindgen_realloc),
        r = Re;
      M.parserconfig_set_opening_tag(this.ptr, t, r);
    }
    get closing_tag() {
      try {
        let r = M.__wbindgen_add_to_stack_pointer(-16);
    ...
    set closing_tag(e) {
      let t = gt(e, M.__wbindgen_malloc, M.__wbindgen_realloc),
        r = Re;
      M.parserconfig_set_closing_tag(this.ptr, t, r);
    }
    get global_var() {
      try {
        let r = M.__wbindgen_add_to_stack_pointer(-16);
  ...
  sn = class {
    ...
    render_content(e, t) {
      try {
        let a = M.__wbindgen_add_to_stack_pointer(-16),
          l = gt(e, M.__wbindgen_malloc, M.__wbindgen_realloc),
          c = Re;
        M.renderer_render_content(a, this.ptr, l, c, Ws(t));
        var r = Ne()[a / 4 + 0],
          i = Ne()[a / 4 + 1],
          o = Ne()[a / 4 + 2];
        if (o) throw bi(i);
        ...
        M.__wbindgen_add_to_stack_pointer(16), (Ke[wr++] = void 0);
      }
    }
  };
...
function zs() {
  ...
  return (
    ...
    (n.wbg.__wbindgen_string_get = function (e, t) {
      ...
      var o = Us(i) ? 0 : gt(i, M.__wbindgen_malloc, M.__wbindgen_realloc),
        a = Re;
      (Ne()[e / 4 + 1] = a), (Ne()[e / 4 + 0] = o);
    }),
    ...
    (n.wbg.__wbindgen_debug_string = function (e, t) {
      let r = Ei(Pe(t)),
        i = gt(r, M.__wbindgen_malloc, M.__wbindgen_realloc),
        o = Re;
      (Ne()[e / 4 + 1] = o), (Ne()[e / 4 + 0] = i);
    }),
    (n.wbg.__wbindgen_throw = function (e, t) {
      throw new Error(Et(e, t));
    }),
    n
  );
}
...
async function Vo(n) {
  typeof n == 'undefined' && (n = new URL('rusty_engine_bg.wasm', Xs.url));
  let e = zs();
  (typeof n == 'string' ||
    ...
    (n = fetch(n)),
    Js(e);
  let { instance: t, module: r } = await Vs(await n, e);
  return Qs(t, r);
}
var zo = Vo;
var Jo = Ji(
...
var cn = class {
  constructor(e) {
    this.plugin = e;
    (this.functions_generator = new wi(this.plugin)), (this.parser = new ki());
  }
  async setup() {
    (this.files_with_pending_templates = new Set()),
      await this.parser.init(),
      await this.functions_generator.init(),
      this.plugin.registerMarkdownPostProcessor((e, t) => this.process_dynamic_templates(e, t));
  }
  create_running_config(e, t, r) {
    let i = vt(this.plugin.app);
  ...
  async parse_template(e, t) {
    let r = await this.functions_generator.generate_object(e, Xe.USER_INTERNAL);
    return (this.current_functions_object = r), await this.parser.parse_commands(t, r);
  }
  ...
  async create_new_note_from_template(e, t, r, i = !0) {
    ...
    let o = (e instanceof de.TFile && e.extension) || 'md',
      a = await Se(async () => {
        let m = t instanceof de.TFolder ? t.path : t,
          _ = this.plugin.app.vault.getAvailablePath(
            (0, de.normalizePath)(`${m ?? ''}/${r || 'Untitled'}`),
            o,
          ),
          w = lo(_);
        return (
          w &&
            !this.plugin.app.vault.getAbstractFileByPathInsensitive(w) &&
            (await this.plugin.app.vault.createFolder(w)),
          this.plugin.app.vault.create(_, '')
        );
  ...
  async append_template_to_active_file(e) {
    let t = this.plugin.app.workspace.getActiveViewOfType(de.MarkdownView),
      r = this.plugin.app.workspace.activeEditor;
    if (!r || !r.file || !r.editor) {
      oe(new P("No active editor, can't append templates."));
      return;
    }
    let { path: i } = r.file;
    ...
    let { content: l, frontmatter: c } = vn(a),
      m = r.editor.getDoc(),
      _ = m.listSelections();
    m.replaceSelection(l),
      t &&
      ...
      this.plugin.app.workspace.trigger('templater:template-appended', {
        ...
        content: a,
        oldSelections: _,
        newSelections: m.listSelections(),
      }),
  ...
  async write_template_to_file(e, t) {
    ...
    let { content: d, frontmatter: m } = vn(c);
    if (a?.path === t.path && o && o.editor && i) {
      let _ = '',
        { content: w, frontmatter: b } = vn(o.editor.getValue());
      ur(b, m),
...
`),
    ...
    this.plugin.app.workspace.trigger('templater:new-note-from-template', { file: t, content: c }),
  ...
  overwrite_active_file_commands() {
    let e = this.plugin.app.workspace.activeEditor;
    if (!e || !e.file) {
      oe(new P("Active editor is null, can't overwrite content"));
      return;
    }
  ...
  async overwrite_file_commands(e, t = !1) {
    ...
    await this.plugin.app.vault.modify(e, o),
      this.plugin.app.workspace.trigger('templater:overwrite-file', { file: e, content: o }),
  ...
  async process_dynamic_templates(e, t) {
    ...
    for (; (o = i.nextNode()); ) {
      ...
      if (c !== null) {
        let d = r.exec(c);
        if (d !== null) {
          let m = this.plugin.app.metadataCache.getFirstLinkpathDest('', t.sourcePath);
          if (!m || !(m instanceof de.TFile)) return;
          if (!a) {
            a = !0;
            let _ = this.create_running_config(m, m, 4);
            (l = await this.functions_generator.generate_object(_, Xe.USER_INTERNAL)),
        ...
        for (; d != null; ) {
          ...
          if (_ == null) return;
          let w = r.lastIndex - d[0].length,
            b = r.lastIndex;
          (c = c.substring(0, w) + _ + c.substring(b)),
            (r.lastIndex += _.length - d[0].length),
            (d = r.exec(c));
        }
        o.nodeValue = c;
      }
  ...
  get_new_file_template_for_folder(e) {
    do {
      let t = this.plugin.settings.folder_templates.find((r) => r.folder == e.path);
      if (t && t.template) return t.template;
      e = e.parent;
    } while (e);
  }
  get_new_file_template_for_file(e) {
    let t = this.plugin.settings.file_templates.find((r) => new RegExp(r.regex).test(e.path));
    if (t && t.template) return t.template;
  }
  static async on_file_creation(e, t, r) {
    if (!(r instanceof de.TFile) || r.extension !== 'md') return;
    ...
    let o = await t.vault.read(r),
      a = (0, de.getFrontMatterInfo)(o),
      l = o.length - a.contentStart;
    if (l == 0 && e.plugin.settings.enable_folder_templates) {
      let c = e.get_new_file_template_for_folder(r.parent);
      if (!c) return;
      let d = await Se(async () => Mt(t, c), `Couldn't find template ${c}`);
      if (d == null) return;
      ...
      r.stat.size <= c
        ...
        : console.log(`Templater skipped parsing ${r.path} because file size exceeds ${c}`);
    }
  }
  async execute_startup_scripts() {
    for (let e of this.plugin.settings.startup_templates) {
      if (!e) continue;
      let t = Ce(() => Mt(this.plugin.app, e), `Couldn't find startup template "${e}"`);
      if (!t) continue;
      let { path: r } = t;
      this.start_templater_task(r);
...
var br = class {
  ...
  setup() {
    this.plugin.app.workspace.onLayoutReady(() => {
      if (
        ...
        this.plugin.app.vault.getConfig('openBehavior') === 'daily'
      ) {
        let t = this.plugin.app.internalPlugins.getEnabledPluginById('daily-notes');
        if (t) {
          let { folder: r, format: i } = t.options,
            o = (0, ln.normalizePath)(`${r}/${(0, ln.moment)().format(i)}.md`),
            a = vt(this.plugin.app);
          a?.path === o && cn.on_file_creation(this.templater, this.plugin.app, a);
        }
      }
  ...
  update_trigger_file_on_creation() {
    this.settings.trigger_on_file_creation
      ? ((this.trigger_on_file_creation_event = this.plugin.app.vault.on('create', (e) =>
          cn.on_file_creation(this.templater, this.plugin.app, e),
        )),
...
var Si = class {
  ...
  setup() {
    this.plugin.addCommand({
      ...
      icon: 'templater-icon',
      hotkeys: Er.Platform.isMacOS ? void 0 : [{ modifiers: ['Alt'], key: 'e' }],
      callback: () => {
      ...
      this.plugin.addCommand({
        ...
        icon: 'templater-icon',
        hotkeys: Er.Platform.isMacOS ? void 0 : [{ modifiers: ['Alt'], key: 'r' }],
        callback: () => {
      ...
      this.plugin.addCommand({
        ...
        icon: 'templater-icon',
        hotkeys: Er.Platform.isMacOS ? void 0 : [{ modifiers: ['Alt'], key: 'n' }],
        callback: () => {
  ...
  add_template_hotkey(e, t) {
    if ((this.remove_template_hotkey(e), t)) {
      let r = this.plugin.settings.templates_folder
      ...
      this.plugin.addCommand({
        ...
        callback: () => {
          let o = Ce(
            () => Mt(this.plugin.app, t),
            "Couldn't find the template file associated with this hotkey",
          );
          !o || this.plugin.templater.append_template_to_active_file(o);
        },
      }),
        this.plugin.addCommand({
          id: `create-${t}`,
          ...
          callback: () => {
            ...
            !o || this.plugin.templater.create_new_note_from_template(o);
          },
        });
    }
  }
  remove_template_hotkey(e) {
    e && (this.plugin.removeCommand(`${e}`), this.plugin.removeCommand(`create-${e}`));
  }
};
var Oi = X(require('obsidian'));
...
var Di = class {
  ...
  async jump_to_next_cursor_location() {
    ...
    let t = e.editor.getValue(),
      { cursor_matches: r, positions: i } = this.get_cursor_matches_and_positions(t);
    if (!i || !r) return;
    let o = e instanceof Ci.MarkdownView ? e.currentMode.getFoldInfo() : null,
      a = [];
    for (let l = r.length - 1; l >= 0; l--) {
      let c = r[l],
        d = this.get_editor_position_from_index(t, c.index),
        m = this.get_editor_position_from_index(t, c.index + c[0].length);
      a.push({ from: d, to: m, text: '' });
    }
    e.editor.transaction({ changes: a, selections: i.map((l) => ({ from: l })) }),
      o &&
        Array.isArray(o.folds) &&
        (i.forEach((l) => {
          o.folds = o.folds.filter((c) => c.from > l.line || c.to < l.line);
        }),
        e instanceof Ci.MarkdownView && (e.currentMode.applyFoldInfo(o), await jt(100), e.save()));
    try {
      if (this.app.vault.getConfig('vimMode')) {
        let l = e.editor.cm.cm;
        window.CodeMirrorAdapter.Vim.handleKey(l, 'i', 'mapping');
      }
    } catch (l) {
      console.warn('Templater: Failed to enter insert mode for vim users.', l);
    }
  }
...
`,
  ...
  get_cursor_matches_and_positions(e) {
    let t = /<%\s*tp\.file\.cursor\((?<order>[0-9]*)\)\s*%>/g,
      r = Array.from(e.matchAll(t));
    if (r.length === 0) return {};
    r.sort((d, m) => Number(d.groups?.order || 0) - Number(m.groups?.order || 0));
    let i = r[0][0],
      o = r.filter((d) => d[0] === i),
      a = o[0][1] === '' ? [o[0]] : o,
      l = [],
    ...
    for (let d of a) {
      let m = d.index - c;
      l.push(this.get_editor_position_from_index(e, m)),
        (e = e.slice(0, m) + e.slice(m + d[0].length)),
        (c += d[0].length);
    }
    return { cursor_matches: a, positions: l };
  }
};
var ea = X(require('obsidian'));
var ec = {
    app: {
      name: 'app',
      description:
      ...
      functions: {
        now: {
          ...
          examples: [
            ...
            { name: 'Date now with format', example: '<% tp.date.now("Do MMMM YYYY") %>' },
            { name: 'Last week', example: '<% tp.date.now("YYYY-MM-DD", -7) %>' },
            { name: 'Next week', example: '<% tp.date.now("YYYY-MM-DD", 7) %>' },
            { name: 'Last month', example: '<% tp.date.now("YYYY-MM-DD", "P-1M") %>' },
            { name: 'Next year', example: '<% tp.date.now("YYYY-MM-DD", "P1Y") %>' },
            {
        ...
        weekday: {
          ...
          examples: [
            { name: "This week's Monday", example: '<% tp.date.weekday("YYYY-MM-DD", 0) %>' },
            { name: 'Next Monday', example: '<% tp.date.weekday("YYYY-MM-DD", 7) %>' },
            {
    ...
    file: {
      ...
      functions: {
        content: {
          ...
          examples: [{ name: 'Retrieve file content', example: '<% tp.file.content %>' }],
        },
        create_new: {
          name: 'create_new',
          ...
          args: [
            ...
            },
            {
              name: 'folder',
              description:
                'The folder to put the new file in, defaults to Obsidian\'s default location. If you want the file to appear in a different folder, specify it with `"PATH/TO/FOLDERNAME"` or `tp.app.vault.getAbstractFileByPath("PATH/TO/FOLDERNAME")`.',
            },
          ],
          examples: [
            {
        ...
        creation_date: {
          ...
          examples: [
            { name: 'File creation date', example: '<% tp.file.creation_date() %>' },
            {
...
`,
        ...
        cursor_append: {
          ...
          args: [
            { name: 'content', description: 'The content to append after the active cursor.' },
          ],
          examples: [
            { name: 'File cursor append', example: '<% tp.file.cursor_append("Some text") %>' },
          ],
        },
        exists: {
          name: 'exists',
          ...
          examples: [
            { name: 'File existence', example: '<% await tp.file.exists("MyFolder/MyFile.md") %>' },
            {
        ...
        find_tfile: {
          ...
          examples: [
            { name: 'File find TFile', example: '<% tp.file.find_tfile("MyFile").basename %>' },
          ],
        },
        folder: {
          name: 'folder',
        ...
        include: {
          ...
          examples: [
            { name: 'File include', example: '<% await tp.file.include("[[Template1]]") %>' },
            {
        ...
        last_modified_date: {
          ...
          examples: [
            { name: 'File last modified date', example: '<% tp.file.last_modified_date() %>' },
            {
        ...
        move: {
          ...
          examples: [
            { name: 'File move', example: '<%* await tp.file.move("/A/B/" + tp.file.title) %>' },
            { name: 'File move and rename', example: '<%* await tp.file.move("/A/B/NewTitle") %>' },
          ],
        },
        path: {
          name: 'path',
        ...
        rename: {
          ...
          examples: [
            { name: 'File rename', example: '<%* await tp.file.rename("MyNewName") %>' },
            {
        ...
        selection: {
          ...
          examples: [{ name: 'File selection', example: '<% tp.file.selection() %>' }],
        },
        tags: {
          name: 'tags',
    ...
    system: {
      ...
      functions: {
        clipboard: {
          ...
          examples: [{ name: 'Clipboard', example: '<% tp.system.clipboard() %>' }],
        },
        prompt: {
          name: 'prompt',
          ...
          args: [
            { name: 'prompt_text', description: 'Text placed above the input field.' },
            { name: 'default_value', description: 'A default value for the input field.' },
            {
          ...
          examples: [
            { name: 'Prompt', example: '<% await tp.system.prompt("Please enter a value") %>' },
            {
...
selected value: <% value %>`,
        ...
        suggester: {
          ...
          args: [
            ...
            { name: 'placeholder', description: 'Placeholder string of the prompt.' },
            {
              name: 'limit',
              description:
...
selected value: <% selectedValue %>`,
        ...
        multi_suggester: {
          ...
          args: [
            ...
            { name: 'title', description: 'Text placed at the top of the modal.' },
            {
              name: 'limit',
              description:
                'Limit the number of items rendered at once (useful to improve performance when displaying large lists).',
    ...
    web: {
      ...
      functions: {
        daily_quote: {
          ...
          examples: [{ name: 'Daily quote', example: '<% await tp.web.daily_quote() %>' }],
        },
        random_picture: {
          name: 'random_picture',
          ...
          args: [
            { name: 'size', description: 'Image size in the format `<width>x<height>`.' },
            {
              name: 'query',
              description:
          ...
          examples: [
            { name: 'Random picture', example: '<% await tp.web.random_picture() %>' },
            {
        ...
        request: {
          ...
          args: [
            { name: 'url', description: 'The URL to which the HTTP request will be made.' },
            {
              name: 'path',
...
var tc = [
  ...
  nc = new Set(tc);
function Zo(n) {
  return typeof n == 'string' && nc.has(n);
}
function Pi(n) {
...
var Ni = class {
  ...
  async get_all_functions_documentation(e, t) {
    if (e === 'app') return this.get_app_functions_documentation(this.plugin.app, t);
    if (e === 'user') {
      if (!this.plugin.settings || !this.plugin.settings.user_scripts_folder) return;
      let r = await Se(async () => {
        let i = Je(this.plugin.app, this.plugin.settings.user_scripts_folder).filter(
          (a) => a.extension == 'js',
        );
        return await co(this.plugin.app, i);
      }, "User Scripts folder doesn't exist");
      return !r || r.length === 0
        ? void 0
        : r.reduce(
                ...
                : [
                    ...i,
                    {
                      ...
                      args: o.arguments.reduce(
                        (l, c) => ((l[c.name] = { name: c.name, description: c.description }), l),
                        {},
                      ),
                      example: '',
                    },
  ...
  get_app_functions_documentation(e, t) {
    ...
    for (let c in i) {
      ...
      l.push({
        name: c,
        queryKey: m,
        definition: typeof i[c] == 'function' ? `${d}(${po(i[c])})` : d,
        description: '',
        returns: '',
        example: '',
      });
...
var Mi = class extends ea.EditorSuggest {
  constructor(e) {
    super(e.app);
    this.tp_keyword_regex = /tp\.(?<module>[a-z]*)?(?<fn_trigger>\.(?<fn>[a-zA-Z_.]*)?)?$/;
    (this.documentation = new Ni(e)),
  ...
  async getSuggestions(e) {
    ...
    return (
      ...
      t ? t.filter((r) => r.queryKey.toLowerCase().startsWith(e.query.toLowerCase())) : []
    );
  }
  renderSuggestion(e, t) {
    if ((t.createEl('b', { text: e.name }), Pi(e))) {
      if (e.args && this.getNumberOfArguments(e.args) > 0 && qo(this.intellisense_render_setting)) {
        t.createEl('p', { text: 'Parameter list:' });
        let r = t.createEl('ol');
        for (let [i, o] of Object.entries(e.args)) Gr(r, i, o.description);
      }
      e.returns && Fo(this.intellisense_render_setting) && Gr(t, 'Returns', e.returns);
    }
    this.function_trigger && Pi(e) && t.createEl('code', { text: e.definition }),
      e.description &&
        Lo(this.intellisense_render_setting) &&
...
(function (n) {
  ...
  n.defineMode('javascript', function (e, t) {
    ...
    function b(s) {
      for (var p = !1, A, x = !1; (A = s.next()) != null; ) {
        if (!p) {
          if (A == '/' && !x) return;
          A == '[' ? (x = !0) : x && A == ']' && (x = !1);
        }
    ...
    function O(s, p) {
      ...
      if (A == '.' && s.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/)) return E('number', 'number');
      if (A == '.' && s.match('..')) return E('spread', 'meta');
      if (/[\[\]{}\(\),;\:\.]/.test(A)) return E(A);
      if (A == '=' && s.eat('>')) return E('=>', 'operator');
      if (A == '0' && s.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/))
        return E('number', 'number');
      if (/\d/.test(A))
        return s.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), E('number', 'number');
      if (A == '/')
        return s.eat('*')
          ? ((p.tokenize = K), K(s, p))
          : s.eat('/')
            ? (s.skipToEnd(), E('comment', 'comment'))
            : Vi(s, p, 1)
              ? (b(s), s.match(/^\b(([gimyus])(?![gimyus]*\2))+\b/), E('regexp', 'string-2'))
              : (s.eat('='), E('operator', 'operator', s.current()));
      if (A == '`') return (p.tokenize = D), D(s, p);
      if (A == '#' && s.peek() == '!') return s.skipToEnd(), E('meta', 'meta');
      if (A == '#' && s.eatWhile(d)) return E('variable', 'property');
      if (
        (A == '<' && s.match('!--')) ||
        (A == '-' && s.match('->') && !/\S/.test(s.string.slice(0, s.start)))
      )
        return s.skipToEnd(), E('comment', 'comment');
      if (_.test(A))
        return (
          ...
          A == '?' && s.eat('.') ? E('.') : E('operator', 'operator', s.current())
        );
      if (d.test(A)) {
        s.eatWhile(d);
        var x = s.current();
        if (p.lastType != '.') {
          if (m.propertyIsEnumerable(x)) {
            var I = m[x];
            return E(I.type, I.style, x);
          }
          if (x == 'async' && s.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1))
            return E('async', 'keyword', x);
        }
        return E('variable', 'variable', x);
      }
    }
    function $(s) {
      return function (p, A) {
        var x = !1,
          I;
        if (o && p.peek() == '@' && p.match(w))
          return (A.tokenize = O), E('jsonld-keyword', 'meta');
        for (; (I = p.next()) != null && !(I == s && !x); ) x = !x && I == '\\';
        return x || (A.tokenize = O), E('string', 'string');
      };
    }
    function K(s, p) {
      for (var A = !1, x; (x = s.next()); ) {
        if (x == '/' && A) {
          p.tokenize = O;
          break;
        }
    ...
    function D(s, p) {
      ...
      return E('quasi', 'string-2', s.current());
    }
    var H = '([{}])';
    function F(s, p) {
      ...
      if (!(A < 0)) {
        if (c) {
          var x = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(s.string.slice(s.start, A));
          x && (A = x.index);
        }
        for (var I = 0, Y = !1, z = A - 1; z >= 0; --z) {
          var ve = s.string.charAt(z),
            We = H.indexOf(ve);
          if (We >= 0 && We < 3) {
            if (!I) {
              ++z;
          ...
          else if (d.test(ve)) Y = !0;
          else if (/["'\/`]/.test(ve))
            for (; ; --z) {
              if (z == 0) return;
              var ya = s.string.charAt(z - 1);
              if (ya == ve && s.string.charAt(z - 2) != '\\') {
                z--;
                break;
              }
            }
    ...
    function ne(s, p) {
      ...
      for (var x = s.context; x; x = x.prev)
        for (var A = x.vars; A; A = A.next) if (A.name == p) return !0;
    }
    function Q(s, p, A, x, I) {
      var Y = s.cc;
      for (
        h.state = s,
          h.stream = I,
        ...
        if (z(A, x)) {
          ...
          return h.marked ? h.marked : A == 'variable' && ne(s, x) ? 'variable-2' : p;
        }
      }
    }
      ...
      if (((h.marked = 'def'), !!l)) {
        if (p.context) {
          if (p.lexical.info == 'var' && p.context && p.context.block) {
            var A = _e(s, p.context);
            if (A != null) {
              p.context = A;
              return;
            }
          } else if (!Ie(s, p.localVars)) {
            p.localVars = new ke(s, p.localVars);
            return;
          }
        }
        t.globalVars && !Ie(s, p.globalVars) && (p.globalVars = new ke(s, p.globalVars));
      }
    }
    function _e(s, p) {
      if (p)
        if (p.block) {
          var A = _e(s, p.prev);
          return A ? (A == p.prev ? p : new Ye(A, p.vars, !0)) : null;
        } else return Ie(s, p.vars) ? p : new Ye(p.prev, new ke(s, p.vars), !1);
      else return null;
    }
    function xe(s) {
      return (
        s == 'public' || s == 'private' || s == 'protected' || s == 'abstract' || s == 'readonly'
      );
    }
    function Ye(s, p, A) {
    ...
    var Yt = new ke('this', new ke('arguments', null));
    function Ue() {
      (h.state.context = new Ye(h.state.context, h.state.localVars, !1)), (h.state.localVars = Yt);
    }
    function et() {
    ...
    function B(s, p) {
      var A = function () {
        var x = h.state,
          I = x.indented;
        if (x.lexical.type == 'stat') I = x.lexical.indented;
        else for (var Y = x.lexical; Y && Y.type == ')' && Y.align; Y = Y.prev) I = Y.indented;
        x.lexical = new te(I, h.stream.column(), s, null, x.lexical, p);
      };
      return (A.lex = !0), A;
    }
    function N() {
      var s = h.state;
      s.lexical.prev &&
        (s.lexical.type == ')' && (s.indented = s.lexical.indented), (s.lexical = s.lexical.prev));
    }
    N.lex = !0;
    function q(s) {
      function p(A) {
        return A == s ? f() : s == ';' || A == '}' || A == ')' || A == ']' ? C() : f(p);
      }
      return p;
    }
    function ee(s, p) {
                  ...
                  : s == ';'
                    ...
                    : s == 'if'
                      ...
                      : s == 'function'
                        ? f(_t)
                        : s == 'for'
                          ? f(B('form'), et, Ki, ee, ye, N)
                          : s == 'class' || (c && p == 'interface')
                            ? ((h.marked = 'keyword'), f(B('form', s == 'class' ? s : p), Yi, N))
                            : s == 'variable'
                              ? c && p == 'declare'
                                ...
                                : c &&
                                  ...
                                  ? ((h.marked = 'keyword'),
                                    p == 'enum'
                                      ...
                                      : p == 'type'
                                        ? f(Ri, q('operator'), V, q(';'))
                                        : f(B('form'), Fe, q('{'), B('}'), Hn, N, N))
                                  : c && p == 'namespace'
                                    ? ((h.marked = 'keyword'), f(B('form'), W, ee, N))
                                    : c && p == 'abstract'
                                      ? ((h.marked = 'keyword'), f(ee))
                                      : f(B('stat'), qn)
                              : s == 'switch'
                                ? f(B('form'), kt, q('{'), B('}', 'switch'), et, Hn, N, N, ye)
                                : s == 'case'
                                  ? f(W, q(':'))
                                  : s == 'default'
                                    ? f(q(':'))
                                    : s == 'catch'
                                      ? f(B('form'), Ue, tt, ee, N, ye)
                                      : s == 'export'
                                        ? f(B('stat'), ma, N)
                                        : s == 'import'
                                          ? f(B('stat'), ga, N)
    ...
    function Mn(s, p, A) {
      if (h.state.fatArrowAt == h.stream.start) {
        var x = A ? In : Bn;
        if (s == '(') return f(Ue, B(')'), se(Dt, ')'), N, q('=>'), x, ye);
      ...
      return J.hasOwnProperty(s)
        ...
        : s == 'function'
          ? f(_t, I)
          : s == 'class' || (c && p == 'interface')
            ? ((h.marked = 'keyword'), f(B('form'), da, N))
            : s == 'keyword c' || s == 'async'
              ? f(A ? je : W)
              : s == '('
                ? f(B(')'), nt, q(')'), N, I)
    ...
    function nt(s) {
      return s.match(/[;\}\)\],]/) ? C() : C(W);
    }
    function rt(s, p) {
      return s == ',' ? f(nt) : ht(s, p, !1);
    }
    function ht(s, p, A) {
      var x = A == !1 ? rt : ht,
        I = A == !1 ? W : je;
      if (s == '=>') return f(Ue, A ? In : Bn, ye);
      if (s == 'operator')
        return /\+\+|--/.test(p) || (c && p == '!')
          ? f(x)
          : c && p == '<' && h.stream.match(/^([^<>]|<[^<>]*>)*>\s*\(/, !1)
            ...
            : p == '?'
              ? f(W, q(':'), I)
              : f(I);
      if (s == 'quasi') return C(St, x);
      if (s != ';') {
        if (s == '(') return un(je, ')', 'call', x);
        if (s == '.') return f(pn, x);
    ...
    function St(s, p) {
      return s != 'quasi' ? C() : p.slice(p.length - 2) != '${' ? f(St) : f(nt, On);
    }
    function On(s) {
      if (s == '}') return (h.marked = 'string-2'), (h.state.tokenize = D), f(St);
    }
    function Bn(s) {
      return F(h.stream, h.state), C(s == '{' ? ee : W);
    }
    function In(s) {
      return F(h.stream, h.state), C(s == '{' ? ee : je);
    }
    function it(s) {
      return function (p) {
        return p == '.'
    ...
    function Fn(s, p) {
      if (p == 'target') return (h.marked = 'keyword'), f(ht);
    }
    function qn(s) {
    ...
    function Ct(s, p) {
      if (s == 'async') return (h.marked = 'property'), f(Ct);
      if (s == 'variable' || h.style == 'keyword') {
        if (((h.marked = 'property'), p == 'get' || p == 'set')) return f(Ln);
        var A;
        return (
          c &&
        ...
        if (c && xe(p)) return (h.marked = 'keyword'), f(Ct);
        if (s == '[') return f(W, Gt, q(']'), Ge);
        if (s == 'spread') return f(je, Ge);
        if (p == '*') return (h.marked = 'keyword'), f(Ct);
        if (s == ':') return C(Ge);
      }
    }
    function Ln(s) {
      return s != 'variable' ? C(Ge) : ((h.marked = 'property'), f(_t));
    }
    function Ge(s) {
      if (s == ':') return f(je);
      if (s == '(') return C(_t);
    ...
    function se(s, p, A) {
      function x(I, Y) {
        if (A ? A.indexOf(I) > -1 : I == ',') {
          var z = h.state.lexical;
          return (
            z.info == 'call' && (z.pos = (z.pos || 0) + 1),
            f(function (ve, We) {
              return ve == p || We == p ? C() : C(s);
            }, x)
          );
        }
        return I == p || Y == p ? f() : A && A.indexOf(';') > -1 ? C(s) : f(q(p));
      }
      return function (I, Y) {
    ...
    function Li(s) {
      if (c && s == ':') return h.stream.match(/^\s*\w+\s+is\b/, !1) ? f(W, oa, V) : f(V);
    }
    function oa(s, p) {
    ...
    function V(s, p) {
      if (p == 'keyof' || p == 'typeof' || p == 'infer' || p == 'readonly')
        return (h.marked = 'keyword'), f(p == 'typeof' ? je : V);
      if (s == 'variable' || p == 'void') return (h.marked = 'type'), f(ot);
      if (p == '|' || p == '&') return f(V);
      if (s == 'string' || s == 'number' || s == 'atom') return f(ot);
      if (s == '[') return f(B(']'), se(V, ']', ','), N, ot);
      if (s == '{') return f(B('}'), kr, N, ot);
      if (s == '(') return f(se(Cr, ')'), aa, ot);
      if (s == '<') return f(se(V, '>'), V);
      if (s == 'quasi') return C(Sr, ot);
    }
    function aa(s) {
      if (s == '=>') return f(V);
    }
    function kr(s) {
      return s.match(/[\}\)\]]/) ? f() : s == ',' || s == ';' ? f(kr) : C(fn, kr);
    }
    function fn(s, p) {
      if (s == 'variable' || h.style == 'keyword') return (h.marked = 'property'), f(fn);
      if (p == '?' || s == 'number' || s == 'string') return f(fn);
      if (s == ':') return f(V);
      if (s == '[') return f(q('variable'), ia, q(']'), fn);
      if (s == '(') return C(Vt, fn);
      if (!s.match(/[;\}\)\],]/)) return f();
    }
    function Sr(s, p) {
      return s != 'quasi' ? C() : p.slice(p.length - 2) != '${' ? f(Sr) : f(V, sa);
    }
    function sa(s) {
      if (s == '}') return (h.marked = 'string-2'), (h.state.tokenize = D), f(Sr);
    }
    function Cr(s, p) {
    ...
    function ot(s, p) {
      if (p == '<') return f(B('>'), se(V, '>'), N, ot);
      if (p == '|' || s == '.' || p == '&') return f(V);
      if (s == '[') return f(V, q(']'), ot);
      if (p == 'extends' || p == 'implements') return (h.marked = 'keyword'), f(V);
      if (p == '?') return f(V, q(':'), V);
    }
    function ca(s, p) {
      if (p == '<') return f(B('>'), se(V, '>'), N, ot);
    ...
    function Dr(s, p) {
      return p == 'enum' ? ((h.marked = 'keyword'), f(Wi)) : C(Fe, Gt, At, ua);
    }
    function Fe(s, p) {
    ...
    function $i(s, p) {
      if (s == 'keyword b' && p == 'else') return f(B('form', 'else'), ee, N);
    }
    function Ki(s, p) {
      if (p == 'await') return f(Ki);
      if (s == '(') return f(B(')'), fa, N);
    }
    function fa(s) {
      return s == 'var' ? f(Dr, Wt) : s == 'variable' ? f(Wt) : C(Wt);
    }
    function Wt(s, p) {
      return s == ')'
        ? f()
        : s == ';'
          ? f(Wt)
          : p == 'in' || p == 'of'
            ? ((h.marked = 'keyword'), f(W, Wt))
            : C(W, Wt);
    }
    function _t(s, p) {
      if (p == '*') return (h.marked = 'keyword'), f(_t);
      if (s == 'variable') return Ee(p), f(_t);
      if (s == '(') return f(Ue, B(')'), se(Dt, ')'), N, Li, ee, ye);
      if (c && p == '<') return f(B('>'), se($n, '>'), N, _t);
    }
    function Vt(s, p) {
      if (p == '*') return (h.marked = 'keyword'), f(Vt);
      if (s == 'variable') return Ee(p), f(Vt);
      if (s == '(') return f(Ue, B(')'), se(Dt, ')'), N, Li, ye);
      if (c && p == '<') return f(B('>'), se($n, '>'), N, Vt);
    }
    function Ri(s, p) {
      if (s == 'keyword' || s == 'variable') return (h.marked = 'type'), f(Ri);
      if (p == '<') return f(B('>'), se($n, '>'), N);
    }
    function Dt(s, p) {
      return (
        p == '@' && f(W, Dt),
    ...
    function da(s, p) {
      return s == 'variable' ? Yi(s, p) : Kn(s, p);
    }
    function Yi(s, p) {
      if (s == 'variable') return Ee(p), f(Kn);
    }
    function Kn(s, p) {
      if (p == '<') return f(B('>'), se($n, '>'), N, Kn);
      if (p == 'extends' || p == 'implements' || (c && s == ','))
        return p == 'implements' && (h.marked = 'keyword'), f(c ? V : W, Kn);
      if (s == '{') return f(B('}'), at, N);
    }
    function at(s, p) {
      if (
        s == 'async' ||
        (s == 'variable' &&
          (p == 'static' || p == 'get' || p == 'set' || (c && xe(p))) &&
          h.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
      )
        return (h.marked = 'keyword'), f(at);
      if (s == 'variable' || h.style == 'keyword') return (h.marked = 'property'), f(dn, at);
      if (s == 'number' || s == 'string') return f(dn, at);
      if (s == '[') return f(W, Gt, q(']'), dn, at);
      if (p == '*') return (h.marked = 'keyword'), f(at);
      if (c && s == '(') return C(Vt, at);
      if (s == ';' || s == ',') return f(at);
      if (s == '}') return f();
      if (p == '@') return f(W, at);
    }
    ...
    function Ui(s, p) {
      ...
      if (s == 'variable') return C(je, Ui);
    }
    function ga(s) {
      return s == 'string' ? f() : s == '(' ? C(W) : s == '.' ? C(rt) : C(Rn, Gi, Pr);
    }
    function Rn(s, p) {
      return s == '{'
        ? un(Rn, '}')
        : (s == 'variable' && Ee(p), p == '*' && (h.marked = 'keyword'), f(ha));
    }
    function Gi(s) {
      if (s == ',') return f(Rn, Gi);
    }
    function ha(s, p) {
      if (p == 'as') return (h.marked = 'keyword'), f(Rn);
    }
    function Pr(s, p) {
    ...
    function Wi() {
      return C(B('form'), Fe, q('{'), B('}'), se(_a, '}'), N, N);
    }
    function _a() {
      return C(Fe, At);
    }
    ...
    function Vi(s, p, A) {
      return (
        ...
        (p.lastType == 'quasi' && /\{\s*$/.test(s.string.slice(0, s.pos - (A || 0))))
      );
    }
    return {
      startState: function (s) {
        var p = {
          ...
          context: t.localVars && new Ye(null, null, !1),
          indented: s || 0,
        };
      ...
      token: function (s, p) {
        ...
        return S == 'comment'
          ? A
          : ((p.lastType = S == 'operator' && (k == '++' || k == '--') ? 'incdec' : S),
            Q(p, A, S, k, s));
      },
      indent: function (s, p) {
        if (s.tokenize == K || s.tokenize == D) return n.Pass;
        ...
        if (!/^\s*else\b/.test(p))
          for (var Y = s.cc.length - 1; Y >= 0; --Y) {
            var z = s.cc[Y];
            if (z == N) x = x.prev;
            else if (z != $i && z != ye) break;
          }
        for (
          ;
          (x.type == 'stat' || x.type == 'form') &&
          (A == '}' ||
            ((I = s.cc[s.cc.length - 1]) && (I == rt || I == ht) && !/^[,\.=+\-*:?[\(]/.test(p)));

        )
          x = x.prev;
        i && x.type == ')' && x.prev.type == 'stat' && (x = x.prev);
        var ve = x.type,
          We = A == ve;
        return ve == 'vardef'
          ? x.indented + (s.lastType == 'operator' || s.lastType == ',' ? x.info.length + 1 : 0)
          : ve == 'form' && A == '{'
            ? x.indented
            : ve == 'form'
              ? x.indented + r
              : ve == 'stat'
                ? x.indented + (xa(s, p) ? i || r : 0)
                : x.info == 'switch' && !We && t.doubleIndentSwitch != !1
                  ? x.indented + (/^(?:case|default)\b/.test(p) ? r : 2 * r)
                  : x.align
                    ? x.column + (We ? 0 : 1)
                    : x.indented + (We ? 0 : r);
      },
    ...
    return {
      ...
      token: function (i, o) {
        return (
          ...
          i.start == o.basePos && ((o.baseCur = e.token(i, o.base)), (o.basePos = i.pos)),
          i.start == o.overlayPos &&
            ((i.pos = i.start), (o.overlayCur = t.token(i, o.overlay)), (o.overlayPos = i.pos)),
...
var ta = X(require('@codemirror/language')),
  na = X(require('@codemirror/state')),
  ra = 'templater',
  Bi = 'templater-command',
  Ii = 'templater-inline',
  rc = 'templater-opening-tag',
  ic = 'templater-closing-tag',
  oc = 'templater-interpolation-tag',
  ac = 'templater-execution-tag',
  Fi = class {
    constructor(e) {
      this.plugin = e;
      (this.cursor_jumper = new Di(e.app)), (this.activeEditorExtensions = []);
    }
    desktopShouldHighlight() {
      return Oi.Platform.isDesktopApp && this.plugin.settings.syntax_highlighting;
    }
    mobileShouldHighlight() {
      return Oi.Platform.isMobile && this.plugin.settings.syntax_highlighting_mobile;
    }
    async setup() {
      (this.autocomplete = new Mi(this.plugin)),
        this.plugin.registerEditorSuggest(this.autocomplete),
        await this.registerCodeMirrorMode(),
        (this.templaterLanguage = na.Prec.high(
          ta.StreamLanguage.define(window.CodeMirror.getMode({}, ra)),
        )),
        this.templaterLanguage === void 0 &&
          oe(new P('Unable to enable syntax highlighting. Could not define language.')),
    ...
    async disable_highlighter() {
      this.activeEditorExtensions.length > 0 &&
        (this.activeEditorExtensions.pop(), this.plugin.app.workspace.updateOptions());
    }
    async jump_to_next_cursor_location(e = null, t = !1) {
      (t && !this.plugin.settings.auto_jump_to_cursor) ||
        (e && vt(this.plugin.app) !== e) ||
        (await this.cursor_jumper.jump_to_next_cursor_location());
    }
    async registerCodeMirrorMode() {
      if (!this.desktopShouldHighlight() && !this.mobileShouldHighlight()) return;
      let e = window.CodeMirror.getMode({}, 'javascript');
      if (e.name === 'null') {
        oe(new P("Javascript syntax mode couldn't be found, can't enable syntax highlighting."));
        return;
      }
      let t = window.CodeMirror.customOverlayMode;
      if (t == null) {
        oe(new P("Couldn't find customOverlayMode, can't enable syntax highlighting."));
        return;
      }
      window.CodeMirror.defineMode(ra, function (r) {
        let i = {
          startState: function () {
            return {
          ...
          token: function (o, a) {
            if ((o.sol() && a.inCommand && (a.freeLine = !0), a.inCommand)) {
              ...
              if (o.match(/[-_]{0,1}%>/, !0)) {
                ...
                let m = a.tag_class;
                return (a.tag_class = ''), `line-${Ii} ${Bi} ${ic} ${m}`;
              }
              let d = e.token && e.token(o, a);
              return (
                o.peek() == null && a.freeLine && (c += ' line-background-templater-command-bg'),
                a.freeLine || (c += ` line-${Ii}`),
                `${c} ${Bi} ${d}`
              );
            }
            ...
            if (l != null) {
              ...
              return (a.inCommand = !0), `line-${Ii} ${Bi} ${rc} ${a.tag_class}`;
            }
...
var qi = class extends Tr.Plugin {
  async onload() {
    await this.load_settings(),
      (this.templater = new cn(this)),
      await this.templater.setup(),
      (this.editor_handler = new Fi(this)),
      await this.editor_handler.setup(),
      (this.fuzzy_suggester = new ci(this)),
      (this.event_handler = new br(this, this.templater, this.settings)),
      this.event_handler.setup(),
      (this.command_handler = new Si(this)),
      this.command_handler.setup(),
      (0, Tr.addIcon)('templater-icon', Ko),
      this.addRibbonIcon('templater-icon', 'Templater', async () => {
        this.fuzzy_suggester.insert_template();
      }).setAttribute('id', 'rb-templater-icon'),
      this.addSettingTab(new si(this)),
  ...
  async load_settings() {
    this.settings = Object.assign({}, Ho, await this.loadData());
  }
};
